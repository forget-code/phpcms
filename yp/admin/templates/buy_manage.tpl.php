...
&nbsp;&nbsp;
<?=form::select_category('yp', 0, 'catid', 'catid', '请选择分类进行管理', $catid,'onchange="if(this.value!=\'\'){location=\'?mod=yp&file=buy&action=manage&catid=\'+this.value;}"',2)?>
</td>
</tr>
</table>
</form>
...
<td><a href="<?=show_url('buy',$info['id'])?>" target="_blank"><?=output::style($info['title'], $info['style'])?></a> <?=$info['thumb'] ? '<font color="red">图</font>' : ''?>&nbsp;<?=$info['elite']?'<font color="green">荐</font>': ''?></td>
