...
链接地址：<input name='channel[linkurl]' type='text' id='linkurl' size='40' maxlength='200'>  <?=$page_select?>
  ...
  <tbody id='Tabs2' style='display:none'>
    ...
    <tr>
      ...
      <td class='tablerow'>
<input name='channel[uploadfiletype]' type='text' id='uploadtype' value='gif|jpg|jpeg|bmp|swf|rm|mp3|wav|mid|midi|ra|avi|mpg|mpeg|asf|asx|wma|mov|rar|zip|exe|doc|xls|chm|hlp' size='60' maxlength='200'>
	  </td>
	</tr>
  </tbody>
