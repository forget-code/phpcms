...
<table cellpadding="2" cellspacing="1" class="tableborder">
  ...
  <tr>
    <td class="tablerow">用户组：</td>
    <td class="tablerow"><?=$groupid?></td>
 </tr>
  <tr>
    <td class="tablerow">用户状态：</td>
    <td class="tablerow"><input type='radio' name='locked' value='0' <?php if($locked==0){ ?> checked <?php } ?>>正常&nbsp;&nbsp; <input type='radio' name='locked' value='1' <?php if($locked==1){ ?> checked <?php } ?>>锁定</td>
 </tr> 
</tbody>
