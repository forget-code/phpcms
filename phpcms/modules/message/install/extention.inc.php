...
$menu_db->insert(array('name'=>'my_outbox', 'parentid'=>$parentid, 'm'=>'message', 'c'=>'message', 'a'=>'my_outbox', 'data'=>'', 'listorder'=>0, 'display'=>'1'));
$menu_db->insert(array('name'=>'my_inbox', 'parentid'=>$parentid, 'm'=>'message', 'c'=>'message', 'a'=>'my_inbox', 'data'=>'', 'listorder'=>0, 'display'=>'1'));
...
$language = array('message'=>'短消息', 'send_one'=>'发送消息', 'delete_message'=>'删除短消息', 'my_outbox'=>'我的发件箱', 'my_inbox'=>'我的收件箱', 'message_send'=>'群发短消息', 'message_group_manage'=>'群发短消息管理');
?>