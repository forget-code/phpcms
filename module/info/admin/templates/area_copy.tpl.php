...
<form method="post" name="myform" action="?mod=<?=$mod?>&file=<?=$file?>&action=<?=$action?>&channelid=<?=$channelid?>&dosubmit=1"  onsubmit="return check();">
<tr>
...
function intext(Request)
{
	...
	<tr>
	<td>
	复制到:<select name='tochannelid' onchange="if(this.value){getareas(this.value);}" id='tochannelid'>
	<option>目标频道</option>
	<?php 
