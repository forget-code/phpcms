...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			<td width="100%" align="left" valign="middle" colspan="5">受访页面为<?php echo $pageurl; ?>的所有历史数据</td>
		</tr>
		<tr>
...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			...
			<td width="8%" align="center" valign="middle"><a href="<?php echo "$curUri&fdate={$resault[$i][1]}&ldate={$resault[$i][1]}"; ?> target="_self">GO</a></td>
		</tr>
<?php
	}
?>
...
<?php
	$curUri .= "&pageurl=" . urlencode($pageurl);
} else {
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
...
?>
		<tr>
			<td width="54%" align="center" valign="middle" class="tablerowhighlight">受访页面URL</td>
			<td width="7%" align="center" valign="middle" class="tablerowhighlight">访问量</td>
			<td width="8%" align="center" valign="middle" class="tablerowhighlight">访问比率</td>
			<td width="23%" align="center" valign="middle" class="tablerowhighlight">图表</td>
...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			<td width="54%" align="left" valign="middle"><?php if ($resault[$i][1] == '地址栏输入') {echo $resault[$i][1];} else {echo "<a href='{$resault[$i][1]}' target='_blank' title='{$resault[$i][1]}'>{$resault[$i][1]}</a>";} ?></td>
			<td width="7%" align="right" valign="middle"><?php echo $resault[$i][0]; ?></td>
			<td width="8%" align="right" valign="middle"><?php echo $rate_pv; ?>%</td>
			<td width="23%" align="left" valign="middle" style="padding-left:0px;padding-right:3px"><?php if ($imgw_pv == 0) {echo '&nbsp;';} else {echo "<img src='$PHP_SITEURL/$mod/pv.gif' width='$imgw_pv%' border='0' height='16'>";} ?></td>
			<td width="8%" align="center" valign="middle"><a href="<?php echo "$curUri&pageurl=" .urlencode($resault[$i][1]); ?>" target="_self">GO</a></td>
		</tr>
<?php
		}
?>
...
<?php
		$curUri .= "&fdate=$fdate&ldate=$ldate";
	} else {
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
