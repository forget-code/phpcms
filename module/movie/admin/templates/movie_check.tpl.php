...
<td><?=$movie['adddate']?></td>
<td>
<a href="?mod=<?=$mod?>&file=<?=$file?>&action=edit&channelid=<?=$channelid?>&movieid=<?=$movie['movieid']?>&catid=<?=$movie['catid']?>&referer=<?=$referer?>">编辑</a> |
<a href="?mod=<?=$mod?>&file=<?=$file?>&action=sendback&channelid=<?=$channelid?>&movieid=<?=$movie['movieid']?>&catid=<?=$movie['catid']?>&referer=<?=$referer?>">退稿</a> |
<a href="?mod=<?=$mod?>&file=<?=$file?>&action=action&job=status&value=-1&movieids=<?=$movie['movieid']?>&channelid=<?=$channelid?>&referer=<?=$referer?>">删除</a>
</td>
</tr>
<? } ?>
