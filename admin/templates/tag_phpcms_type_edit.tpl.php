  ...
  <form name="myform" method="get" action="?">
   ...
   <input name="action" type="hidden" value="edit">
    ...
    <tr> 
      ...
      <td  class="tablerow"><input name="tag_config[keyid]" id="keyid" type="text" size="15" value="<?=$tag_config['keyid']?>"> 
<?=keyid_select('setkeyid', '请选择模块/频道', '', 'onchange="javascript:myform.keyid.value=this.value"')?>
    ...
    <tr> 
      ...
      <td  class="tablerow">
<?=showtpl($mod, 'tag_type', 'tag_config[templateid]', $tag_config['templateid'] ,' id="templateid" ')?>
