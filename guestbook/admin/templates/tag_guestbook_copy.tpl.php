...
<table class="table_form" cellspacing="1" cellpadding="0">
   ...
   <input name="forward" type="hidden" value="<?=$forward?>"> 
    <tr>
      ...
      <td width="75%">
	  <input name="tagname" id="tagname" type="text" size="20" value=""> <input type="button" name="submit" value=" 检查是否已经存在 " onClick="Dialog('?mod=<?=$mod?>&file=<?=$file?>&action=checkname&tagname='+$('tagname').value+'','','300','40','no')"> <br/>
	  </td>
    </tr>
    <tr> 
