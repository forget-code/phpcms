...
<form method="post" name="search">
  <tr>
	...
	<b>显示选项：</b> <input name='passed' type='radio' value='1' onclick="location='?mod=guestbook&file=guestbook&action=manage&passed=1&keyid=<?=$keyid?>'" <? if($passed==1) { ?>checked<? } ?>><a href='?mod=guestbook&file=guestbook&action=manage&passed=1&keyid=<?=$keyid?>'>已审核的留言</a>&nbsp;<input name='passed' type='radio' value='0' onclick="location='?mod=guestbook&file=guestbook&action=manage&passed=0&keyid=<?=$keyid?>'" <? if(!$passed) { ?>checked<? } ?>><a href='?mod=guestbook&file=guestbook&action=manage&passed=0&keyid=<?=$keyid?>'>未审核的留言</a>&nbsp;<input name='keyid' type='hidden' value='<?=$keyid?>'>
