...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			<td width="100%" align="left" valign="middle" colspan="5">访问者浏览器为<?php echo $broswer; ?>的所有历史数据</td>
		</tr>
		<tr>
...
<?php
	...
	$curUri .= "&broswer=" . urlencode($broswer);
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
...
?>
		<tr>
			<td width="30%" align="center" valign="middle" class="tablerowhighlight">浏览器</td>
...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			...
			<td width="8%" align="center" valign="middle"><a href="<?php echo "$curUri&broswer=" . urlencode($resault[$i][1]); ?>" target="_self">GO</a></td>
		</tr>
<?php
		}
?>
