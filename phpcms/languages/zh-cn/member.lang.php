...
$LANG['other_passport_info'] = 'PHPCMS支持使用第三方账号登陆。';
$LANG['input'] = '请输入';
$LANG['checkcode'] = '验证码';
$LANG['validate'] = '验证';
...
$LANG['forget_password_notice'] = '提交后请在一小时内登陆邮箱重置会员密码。';
$LANG['or'] = '或';
$LANG['remember'] = '记住';
$LANG['vip'] = 'vip会员';
$LANG['isvip'] = '是否为vip会员';
...
$LANG['click_login'] = '单击登陆';
$LANG['sina_login'] = '用新浪账号登陆';
