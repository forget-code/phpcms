...
<table cellpadding="2" cellspacing="1" class="tableborder">
  ...
  <form name="myform" method="post" action="?mod=<?=$mod?>&file=<?=$file?>&action=executesql&operation=sql">
   ...
   <tr> 
      <td height="40" align="center" class="tablerow" > <input type="submit" name="submit" value=" 执行SQL "></td>
    </tr>
  </form>
</table>
<table cellpadding="0" cellspacing="0" border="0" width="100%" height="10">
  ...
  <tr>
    <td height="30" class="tablerow" align="center">
	        上传SQL文件：
             ...
             <input type="submit" name="submit" value=" 上传并执行 "><br>只允许上传SQL格式的文件，上传成功后文件中的SQL语句将被立即执行
	</td>
  </tr>
  </form>
</table>
