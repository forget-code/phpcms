...
<?=$category_select?>
    ...
    <tr> 
      <td class="tablerow"><b>调用下载数或每页下载数</b></td>
      <td  class="tablerow"><input name="tag_config[downnum]" type="text" size="10" value="10"></td>
    </tr>
    <tr> 
...
<option value="0">按下载排序排序</option>
<option value="1">按更新时间降序</option>
<option value="2">按更新时间升序</option>
<option value="3">按下载次数降序</option>
<option value="4">按下载次数升序</option>
...
<option value='6'>按评论次数升序</option>
    ...
    <tr> 
      ...
      <td  class="tablerow"><input type="radio" name="tag_config[showdowns]" value="1">是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="tag_config[showdowns]" value="0" checked>否</td>
    </tr>
    <tr> 
...
<option value="10">10列</option>
  ...
  <td  class="tablerow"><input name="tag_config[username]" id="username" type="text" size="15" /> 可调用单个会员的文章</td>
    ...
    <tr> 
      ...
      <td  class="tablerow">
	<?=showtpl($mod,'tag_down_list','tag_config[templateid]')?>
