...
<div class="pad-10">
    <form
        ...
        <input type="hidden" name="domain" id="domain" value="<?php echo $row['domain']?>" />
        <input type="hidden" name="code" id="code" value="<?php echo $row['code']?>" />
        <input type="hidden" name="sdid" id="sdid" value="<?php echo $row['sdid']?>" />
        <input type="hidden" name="group_addr" id="group_addr" value="<?php echo $row['group_addr']?>" />
