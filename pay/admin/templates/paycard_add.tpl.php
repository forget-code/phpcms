...
<table cellpadding="2" cellspacing="1" border="0" align="center" class="tableBorder" >
  ...
  <tr>
    ...
    <td class="tablerow">&nbsp;<INPUT NAME="price" TYPE="text" value="100" size="15">元</td>
  </tr>
  <tr>
    <td align="right" class="tablerow">卡号前缀：</td>
    <td class="tablerow">&nbsp;<INPUT NAME="prefix" TYPE="text" value="<?=date("Y")?>" size="15"></td>
  </tr>
  <tr>
  ...
  <tr height="30">
    ...
    <td class="tablerow">&nbsp;<INPUT TYPE="submit" name="dosubmit" value=" 产生充值卡 "> <INPUT TYPE="reset" name="reset" value=" 重置 "></td>
  </tr>
  </form>
</table>
</body>
