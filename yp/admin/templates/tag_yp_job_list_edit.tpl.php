...
<table cellpadding="2" cellspacing="1" class="tableborder">
  ...
  <form name="myform" method="get" action="?">
   ...
   <input name="action" type="hidden" value="edit">
    ...
    <tr> 
      <td class="tablerow" width="40%"><b>标签说明</b><br/>例如：首页最新推荐招聘，10篇</td>
    ...
    <tr> 
      <td class="tablerow" width="40%"><b>每页招聘数</b></td>
      <td  class="tablerow"><input name="tag_config[jobnum]" type="text" size="10" value="<?=$tag_config['jobnum']?>"></td>
    </tr>
    <tr> 
      <td class="tablerow" width="40%"><b>招聘标题最大字符数</b></td>
...
您可以从下拉框中选择
    ...
    <tr> 
      <td class="tablerow" width="40%"><b>招聘排序方式</b></td>
      <td  class="tablerow">
<select name='tag_config[ordertype]'>
<option value='0' <? if($tag_config['ordertype']==0) { ?>selected<? } ?>>按招聘排序排序</option>
...
<option value="6" <? if($tag_config['datetype']==6) { ?>selected<? } ?>>格式：<?=date("Y-m-d H:i",$PHP_TIME)?></option>
    ...
    <tr> 
      <td class="tablerow" width="40%"><b>是否在招聘标题前显示岗位名称</b></td>
      <td  class="tablerow"><input type="radio" name="tag_config[showstationname]" value="1" <? if($tag_config['showstationname']) { ?>checked<? } ?>>是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="tag_config[showstationname]" value="0" <? if(!$tag_config['showstationname']) { ?>checked<? } ?>>否</td>
    </tr>
    <tr> 
...
<tr> 
  ...
  <td  class="tablerow"><input name="tag_config[username]" id="username" type="text" size="15" value="<?=$tag_config['username']?>"/> 可调用单个会员的招聘</td>
</tr>

    <tr> 
      <td class="tablerow" width="40%"><b>此标签调用的模板</b></td>
      <td  class="tablerow">
	<?=showtpl($mod,'tag_job_list','tag_config[templateid]',$tag_config['templateid'],'id="templateid"')?>
