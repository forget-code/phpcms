...
<table cellpadding="0" cellspacing="1" class="table_form" id='Tabs0' style='display:'>
  ...
  <?=form::select_category($mod, 0, 'category[parentid]', 'parentid', '无（作为一级栏目）', $catid)?>  <font color="red">*</font>
    ...
    <tr>
      ...
      <td><input name='category[catdir]' type='text' id='catdir' size='20' maxlength='50' require="false" datatype="limit" max="50" min="1"  msg="字符长度范围必须为1到50位" msgid="msgid2"><span id="msgid2"></span></td>
    </tr>
    ...
    <tr>
     ...
     <tr>
      ...
      <td><?=form::select_template($mod, 'setting[template_category]', 'template_category', 'category', '','category')?></td>
    </tr>
    <tr>
      <th><strong>列表页模板</strong></th>
      <td><?=form::select_template($mod, 'setting[template_list]', 'template_list','list', '','list')?></td>
    </tr>
    <tr>
      <th><strong>内容页模板</strong></th>
      <td><?=form::select_template($mod, 'setting[template_show]', 'template_show','show', '','show')?></td>
    </tr>
    <tr>
      <th><strong>打印页模板</strong></th>
      <td><?=form::select_template($mod, 'setting[template_print]', 'template_print', 'print', '','print')?></td>
    </tr>
</table>
