...
<table cellpadding="2" cellspacing="1" class="tableborder">
  ...
  <form name="myform" method="get" action="?" onsubmit="return doCheck();">
   ...
   <input type="hidden" name="tag_config[func]" value="<?=$function?>">
    ...
    <tr> 
      <td class="tablerow"><b>标签说明</b><br/>例如：首页最新推荐影片，10篇</td>
...
<?=$category_select?></span> &nbsp;选择时栏目ID会自动加入到表单中
    ...
    <tr> 
      <td class="tablerow"><b>调用影片数或每页影片数</b></td>
      <td  class="tablerow"><input name="tag_config[movienum]" type="text" size="10" value="10"></td>
    </tr>
    <tr> 
    ...
    <tr> 
	 ...
	 <tr> 
      ...
      <td  class="tablerow"><input name="tag_config[letter]" type="text" size="10" value="0"> 例如：a  如果设置为0则表示不限</td>
    </tr>
	    <tr> 
...
您可以从下拉框中选择
    ...
    <tr> 
      <td class="tablerow"><b>影片排序方式</b></td>
      <td  class="tablerow">
<select name="tag_config[ordertype]">
<option value="0">按影片排序排序</option>
<option value="1">按更新时间降序</option>
<option value="2">按更新时间升序</option>
<option value="3">按点播次数降序</option>
<option value="4">按点播次数升序</option>
...
<option value='6'>按评论次数升序</option>
    ...
    <tr> 
      <td class="tablerow"><b>是否在影片标题前显示栏目名称</b></td>
    ...
    <tr> 
      <td class="tablerow"><b>是否在标题后面显示影片次数</b></td>
      <td  class="tablerow"><input type="radio" name="tag_config[showmovies]" value="1">是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="tag_config[showmovies]" value="0" checked>否</td>
    </tr>
    <tr> 
...
<option value="10">10列</option>
  ...
  <td  class="tablerow"><input name="tag_config[username]" id="username" type="text" size="15" /> 可调用单个会员的文章</td>
    ...
    <tr> 
      ...
      <td  class="tablerow">
	<?=showtpl($mod,'tag_movie_list','tag_config[templateid]')?>
