...
<?=$category_select?></span> &nbsp;选择时栏目ID会自动加入到表单中
    ...
    <tr> 
	 ...
	 <tr> 
      ...
      <td  class="tablerow"><input name="tag_config[areaid]" id="setareaid" type="text" size="15" value="0"> 
...
<?=$area_select?>
    ...
    <tr> 
      <td class="tablerow"><b>调用信息数或每页信息数</b></td>
      <td  class="tablerow"><input name="tag_config[infonum]" type="text" size="10" value="10"></td>
    </tr>
    <tr> 
...
<option value='6'>按评论次数升序</option>
    ...
    <tr> 
      <td class="tablerow"><b>是否在信息标题前显示栏目名称</b></td>
    ...
    <tr> 
      <td class="tablerow"><b>是否在标题后面显示信息浏览次数</b></td>
...
<option value="10">10列</option>
  ...
  <td  class="tablerow"><input name="tag_config[username]" id="username" type="text" size="15" /> 可调用单个会员的文章</td>
    ...
    <tr> 
      ...
      <td  class="tablerow">
	<?=showtpl($mod,'tag_info_list','tag_config[templateid]')?>
