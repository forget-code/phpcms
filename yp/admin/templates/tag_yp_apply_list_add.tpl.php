...
<table cellpadding="2" cellspacing="1" class="tableborder">
  ...
  <form name="myform" method="get" action="?" onsubmit="return doCheck();">
   ...
   <input type="hidden" name="tag_config[func]" value="<?=$function?>">
    ...
    <tr> 
      <td class="tablerow"><b>欲从事岗位</b></td>
    ...
    <tr> 
      <td class="tablerow"><b>调用求职数或每页求职数</b></td>
      <td  class="tablerow"><input name="tag_config[applynum]" type="text" size="10" value="10"></td>
    </tr>
...
您可以从下拉框中选择
    ...
    <tr> 
      <td class="tablerow"><b>求职排序方式</b></td>
      <td  class="tablerow">
<select name="tag_config[ordertype]">
<option value="0">按求职排序排序</option>
...
<option value="4">按浏览次数升序</option>
    ...
    <tr> 
      ...
      <td  class="tablerow"><input type="radio" name="tag_config[showexperience]" value="1">是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="tag_config[showexperience]" value="0" checked>否</td>
    </tr>
	    <tr> 
      <td class="tablerow"><b>是否显示毕业学校</b></td>
      <td  class="tablerow"><input type="radio" name="tag_config[showschool]" value="1">是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="tag_config[showschool]" value="0" checked>否</td>
    </tr>
	    <tr> 
      <td class="tablerow"><b>是否显示所学专业</b></td>
      <td  class="tablerow"><input type="radio" name="tag_config[showspecialty]" value="1">是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="tag_config[showspecialty]" value="0" checked>否</td>
    </tr>
    <tr> 
...
<option value="10">10列</option>
    ...
    <tr> 
      ...
      <td  class="tablerow">
	<?=showtpl($mod,'tag_apply_list','tag_config[templateid]')?>
