...
<option value='6'>按评论次数升序</option>
    ...
    <tr> 
      <td class="tablerow"><b>是否在图片标题前显示栏目名称</b></td>
    ...
    <tr> 
      ...
      <td  class="tablerow"><input type="radio" name="tag_config[hits]" value="1">是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="tag_config[hits]" value="0" checked>否</td>
    </tr>
    <tr> 
...
<option value="10">10列</option>
  ...
  <td  class="tablerow"><input name="tag_config[username]" id="username" type="text" size="15" /> 可调用单个会员的文章</td>
    ...
    <tr> 
      ...
      <td  class="tablerow">
	<?=showtpl($mod,'tag_picture_list','tag_config[templateid]')?>
