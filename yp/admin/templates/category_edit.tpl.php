...
<?=form::select_category($mod, 0, 'category[parentid]', 'parentid', '无（作为一级栏目）', $parentid)?>  <font color="red">*</font>
    ...
    <tr>
      ...
      <td><input name='category[catname]' type='text' id='catname' value='<?=$catname?>' size='40' maxlength='50' require="true" datatype="limit|ajax" min="1" max="50" url="?mod=yp&file=category&action=checkname&parentid=<?=$catid?>" msg="字符长度范围必须为1到50位|" msgid="msgid1"> <?=form::style('category[style]',$style)?>  <font color="red">*</font><span id ="msgid1"/></td>
    </tr>
    <tr>
