...
<?=$menu?>
<form name="myform" method="post" action="?mod=<?=$mod?>&file=<?=$file?>&action=add&channelid=<?=$channelid?>" onSubmit='return CheckForm();'>
<input name='area[channelid]' type='hidden' id='channelid' value='<?=$channelid?>'>

<table cellpadding="2" cellspacing="1" class="tableborder">
  <th colspan=2>地区信息</th>
  <tr>
...
<?=$parentid?>  <font color="red">*</font>
    ...
    <tr>
      ...
      <td class='tablerow'><textarea name='area[areaname]'  id='areaname' style="width:200px;height:36px;overflow:visible;"></textarea>
		<?=style_edit('area[style]','')?><br/>
		允许批量添加，一行一个，点回车换行
		</td>
    </tr>

	<tr>
      <td class='tablerow'><strong>地区列表分页url规则</strong></td>
      <td class='tablerow'>
	  <?=$area_urlrule?>
	 </td>
    </tr>
