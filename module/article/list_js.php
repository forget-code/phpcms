...
$articlenum = intval($articlenum);
$articlenum = $articlenum>0 ? $articlenum : 10;
...
articlelist(0,$channelid,$catid,1,$specialid,0,$articlenum,$titlelen,0,$iselite,$datenum,$ordertype,0,0,0,0,0,1);
