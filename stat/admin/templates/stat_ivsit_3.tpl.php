...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			<td width="100%" align="left" valign="middle" colspan="5">来自搜索引擎为<?php echo getEngine($domain); ?>的所有历史数据</td>
		</tr>
		<tr>
...
<?php
if ($pageCount > 1) {
	$curUri .= "&domain=" . urlencode($domain);
	$first = "$curUri&page=1";
...
?>
		<tr>
			<td width="10%" align="center" valign="middle" class="tablerowhighlight">搜索引擎</td>
			<td width="7%" align="center" valign="middle" class="tablerowhighlight">访问量</td>
			<td width="8%" align="center" valign="middle" class="tablerowhighlight">访问比率</td>
			<td width="67%" align="center" valign="middle" class="tablerowhighlight">图表</td>
...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			<td width="10%" align="center" valign="middle"><a href="http://www.<?php echo $resault[$i][1]; ?>/" target="_blank" title="http://www.<?php echo $resault[$i][1]; ?>/"><?php echo getEngine($resault[$i][1]); ?></a></td>
			<td width="7%" align="right" valign="middle"><?php echo $resault[$i][0]; ?></td>
			<td width="8%" align="right" valign="middle"><?php echo $rate_pv; ?>%</td>
			<td width="67%" align="left" valign="middle" style="padding-left:0px;padding-right:3px"><?php if ($imgw_pv == 0) {echo '&nbsp;';} else {echo "<img src='$PHP_SITEURL/$mod/pv.gif' width='$imgw_pv%' border='0' height='16'>";} ?></td>
			<td width="8%" align="center" valign="middle"><a href="<?php echo "$curUri&domain={$resault[$i][1]}"; ?>" target="_self">GO</a></td>
		</tr>
<?php
		}
?>
