        ...
        <table width="100%"  border="0" cellspacing="0" cellpadding="4">
            ...
            <tr>
              <td>
               <table width="100%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#183789">
                  <tr>
                    <th><img src="<?=PHPCMS_PATH?>skin/admin/images/minus.gif" width="20" height="9"><a href="javascript:show('picture')"><font color=#ffffff>图片管理</font></a></td>
                  </tr>
                 <TBODY style="display:''" id="picture">
				 <?php if($_grade<3 && $_CHA['htmlcreatetype']){ ?>
				  ...
				  <?php if($_grade!=5){ ?>
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=picture&action=add&channelid=<?=$channelid?>" target="right"><font color="red">添加图片</font></a></td>
                  </tr>
				  <?php } ?>

				  <?php if($_grade!=4){ ?>
				  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=picture&action=check&channelid=<?=$channelid?>" target="right">审核图片</a></td>
                  </tr>
				  <?php } ?>

				  <?php if($_grade<4){ ?>
				  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=picture&action=manage&channelid=<?=$channelid?>" target="right"><font color="red">管理图片</font></a></td>
                  </tr>
				  <?php } ?>

				  <?php if($_grade!=5){ ?>
				  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=picture&action=myitem&channelid=
					<?=$channelid?>" target="right">我添加的图片</a></td>
                  </tr>
                  <?php } ?>

				  <?php if($_grade<3){ ?>
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=picture&action=special&channelid=<?=$channelid?>" target="right"><font color="red">管理专题图片</font></a></td>
                  </tr>
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=picture&action=move&channelid=<?=$channelid?>" target="right">批量移动图片</a></td>
                  </tr>
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=picture&action=recycle&channelid=<?=$channelid?>" target="right">回收站</a></td>
                  </tr>
				   <?php } ?>
                </tbody>
              </table>
              ...
              <td>
               <table width="100%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#183789">
                 ...
                 <TBODY style="display:" id="extension">
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=comment&file=comment&action=manage&item=pictureid&channelid=<?=$channelid?>" target="right">评论管理</a></td>
                  </tr>
                  <tr>
