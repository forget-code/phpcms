...
$html = "<link href=\"".$PHPCMS['siteurl'].SKIN_PATH."{$mod}.css\" rel=\"stylesheet\" type=\"text/css\" /><div id=\"digg\"><span><strong id=\"diggDivCount_{$contentid}\">{$dig_arr[1]}</strong><br />{$sup}</span><span class=\"cai\"><strong id=\"diggDivCount_down_{$contentid}\">{$dig_arr[2]}</strong><br /><samp id=\"diggDivDo_down_{$contentid}\" onclick=\"digg(0)\" >{$aga}</samp></span></div>";
?>
