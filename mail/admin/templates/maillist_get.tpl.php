...
echo $menu; ?>
<form id="formgetmails" name="formgetmails" method="post" action="?mod=<?php echo $mod; ?>&file=maillist&action=get">
  ...
  <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" class="tableborder">
	...
	<tr>
	  <td class="tablerow"><strong>高级查询条件（SQL语句）</strong><br />
      内容为WHERE 后条件（可以不填写）</td>
	...
	<tr>
      ...
      只能是英文，字母，下划线组成</td>
      <td class="tablerow">
	  <input name="newdata[file]" type="text" value="<?php if($data['file']) echo $data['file']; else echo $data['table'].'_'.date('Ymd'); ?>" size="20" />
	  .txt</td>
	</tr>
	<tr>
	...
	<tr>
      ...
      <td class="tablerow">
	  <input name="dosubmit" type="submit" id="submit" value=" 获取并保存 " />
