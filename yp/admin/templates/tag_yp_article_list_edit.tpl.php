...
<table cellpadding="2" cellspacing="1" class="tableborder">
  ...
  <form name="myform" method="get" action="?">
   ...
   <input name="action" type="hidden" value="edit">
    ...
    <tr> 
      <td class="tablerow" width="40%"><b>标签说明</b><br/>例如：首页最新推荐新闻，10篇</td>
	...
	<?=trade_select('settradeid', '不限', $tag_config['catid'], 'onchange="ChangeInput(this,document.myform.catid)"')?> &nbsp;选择时栏目ID会自动加入到表单中
	</td>
	</tr>
    <tr> 
    ...
    <tr> 
      <td class="tablerow" width="40%"><b>每页新闻数</b></td>
      <td  class="tablerow"><input name="tag_config[articlenum]" type="text" size="10" value="<?=$tag_config['articlenum']?>"></td>
    </tr>
    <tr> 
      <td class="tablerow" width="40%"><b>新闻标题最大字符数</b></td>
...
您可以从下拉框中选择
    ...
    <tr> 
      <td class="tablerow" width="40%"><b>新闻排序方式</b></td>
      <td  class="tablerow">
<select name='tag_config[ordertype]'>
<option value='0' <? if($tag_config['ordertype']==0) { ?>selected<? } ?>>按新闻排序排序</option>
...
<option value="6" <? if($tag_config['datetype']==6) { ?>selected<? } ?>>格式：<?=date("Y-m-d H:i",$PHP_TIME)?></option>
    ...
    <tr> 
      <td class="tablerow" width="40%"><b>是否在新闻标题前显示栏目名称</b></td>
...
<tr> 
  ...
  <td  class="tablerow"><input name="tag_config[username]" id="username" type="text" size="15" value="<?=$tag_config['username']?>"/> 可调用单个会员的新闻</td>
</tr>

    <tr> 
      <td class="tablerow" width="40%"><b>此标签调用的模板</b></td>
      <td  class="tablerow">
	<?=showtpl($mod,'tag_article_list','tag_config[templateid]',$tag_config['templateid'],'id="templateid"')?>
