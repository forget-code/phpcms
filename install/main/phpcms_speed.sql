...
INSERT INTO `phpcms_menu` (`menuid`, `parentid`, `name`, `image`, `url`, `description`, `target`, `style`, `js`, `groupids`, `roleids`, `isfolder`, `isopen`, `listorder`, `userid`, `keyid`) VALUES (326, 319, '批量操作', '', '', '', '_self', '', '', '', '', 1, 0, 0, 0, '');
INSERT INTO `phpcms_menu` (`menuid`, `parentid`, `name`, `image`, `url`, `description`, `target`, `style`, `js`, `groupids`, `roleids`, `isfolder`, `isopen`, `listorder`, `userid`, `keyid`) VALUES (327, 326, '更新全站索引', '', '?mod=phpcms&file=category&action=update_search', '', 'right', '', '', '', '', 0, 0, 0, 0, '');
