...
<?php } else { ?>
	<table cellpadding="2" cellspacing="1" class="tableborder">
	  <tr>
		<th colspan=7><a href="?mod=<?=$mod?>&file=<?=$file?>&action=manage&keyid=<?=$keyid?>"><font color="white">来源管理</font></a></th>
	  </tr>
	...
	<td>&nbsp;&nbsp;
	<input name='submit1' type='submit' value=' 删除选中来源 ' onClick="document.myform.action='?mod=<?=$mod?>&file=<?=$file?>&action=delete&keyid=<?=$keyid?>'" >&nbsp;&nbsp;
