...
<table cellpadding="2" cellspacing="1" border="0" align="center" class="table_info" >
  ...
  <tr>
    <td><strong>管理选项：</b><a href="?mod=<?=$mod?>&file=<?=$file?>&action=add&module=<?=$module?>">添加标签</a> | <a href="?mod=<?=$mod?>&file=<?=$file?>&action=manage&module=<?=$module?>">管理标签</a></td>
  </tr>
</table>
...
<table cellpadding="2" cellspacing="1" class="table_form">
  ...
  <form name="myform" method="get" action="?" >
   ...
   <input name="module" type="hidden" value="<?=$module?>">
    ...
    <tr>
      <td><strong>标签说明</b><br/>例如：首页最新推荐产品，10篇</td>
...
<tbody id="mode0" style="display:block">
    <tr> 
      <td colspan=2 align="center"><b>数据读取字段</strong></td>
    </tr>
    <tr> 
      <td><strong>读取字段</b><br/>请选择要读取的数据表字段</td>
      <td>
<?=form::checkbox($fields, 'tag_config[selectfields]', 'selectfields', $selectfields, 5, '', '', 100)?>
	  </td>
    </tr>
    <tr> 
      <td colspan=2 align="center"><b>数据调用条件</strong></td>
    </tr>
 <?php 
...
?>
    ...
    <tr> 
      <td colspan=2 align="center"><b>数据显示方式</strong></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td><strong>自定义变量</b>（<a href="###" onClick="javascript:var_add();">+</a>）</td>
      <td>
	  <div id="var_define">
