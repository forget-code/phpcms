              ...
              <td>
               <table width="100%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#183789">
                 ...
                 <TBODY style="display:''" id="article">
				  ...
				  <?php if($_grade<3){ ?>
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=article&action=special&channelid=<?=$channelid?>" target="right"><font color="red">管理专题文章</font></a></td>
                  </tr>
                  <tr>
              ...
              <td>
               <table width="100%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#183789">
                 ...
                 <TBODY style="display:" id="extension">
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=comment&file=comment&action=manage&item=articleid&channelid=<?=$channelid?>" target="right">评论管理</a></td>
                  </tr>
                  <tr>
