...
<table cellpadding="2" cellspacing="1" class="tableborder">
  ...
  <form name="myform" id="myform" method="post" action="?mod=<?=$mod?>&file=<?=$file?>&action=<?=$action?>&function=phpcms_mytag" onsubmit="return doCheck();">
    <tr> 
      <td width="30%" class="tablerow"><b>自定义标签名</b><font color="red">*</font></td>
      <td width="70%" class="tablerow"><input name="tagname" type="text" size="20" value="<?=$tagname?>" readonly> 可以用中文</td>
    </tr>
   <tr>
