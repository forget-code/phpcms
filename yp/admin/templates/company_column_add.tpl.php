...
<input name='category[module]' type='hidden' id='module' value='<?=$module?>'>
...
<option value='6'>点击次数（升序）</option>
  ...
  <tbody id='Tabs2' style='display:none'>
	...
	<tr>
      ...
      <td class='tablerow'>
      <input type='radio' name='category[ishtml]' value='1' <?php if($mod['ishtml']==1){ ?>checked <?php } ?> onclick="$('cat_html').style.display='block';$('cat_html_htmldir').style.display='block';$('cat_html_prefix').style.display='block';$('cat_php').style.display='none';"> 是
      <input type='radio' name='category[ishtml]' value='0' <?php if($mod['ishtml']==0){ ?>checked <?php } ?> onclick="$('cat_html').style.display='none';$('cat_html_htmldir').style.display='none';$('cat_html_prefix').style.display='none';$('cat_php').style.display='block';"> 否 
	  </td>
    </tr>
	<tr id="cat_html_htmldir" style='display:<?php if($ishtml==1){ ?>block<?php }else{ ?>none<?php } ?>'> 
      ...
      <td class="tablerow"><input name='category[htmldir]' type='text' id='htmldir' value='html' size='15' maxlength='50'> 仅在栏目信息列页表生成html时有效</td>
    </tr>
	<tr id="cat_html_prefix" style='display:<?php if($mod['ishtml']==1){ ?>block<?php }else{ ?>none<?php } ?>'> 
      ...
      <td class="tablerow"><input name='category[prefix]' type='text' id='prefix' value='pdtlist_' size='15' maxlength='50'> 仅在栏目信息列页表生成html时有效</td>
    </tr>    
