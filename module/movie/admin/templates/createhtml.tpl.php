...
<table width="100%" height="25" border="0" cellpadding="3" cellspacing="0" class="tableborder">
  <tr>
    <td class="tablerow"> <img src="<?=PHPCMS_PATH?>admin/skin/images/pos.gif" align="absmiddle" alt="当前位置" > 当前位置：<a href="?mod=<?=$mod?>&file=<?=$mod?>&action=main&channelid=<?=$channelid?>">影视首页</a> &gt;&gt; <a href="?mod=<?=$mod?>&file=<?=$file?>&action=tohtml&channelid=<?=$channelid?>">发布网页</a> </td>
  </tr>
</table>
...
<table cellpadding="2" cellspacing="1" border="0" align=center class="tableBorder" >
  <tr>
    <th colspan="4">更新影视</th>
  </tr>
<tr align="center">
<td width="25%" class="tablerowhighlight">影视起始ID</td>
<td width="25%" class="tablerowhighlight">影视结束ID</td>
<td width="25%" class="tablerowhighlight">每轮生成影视数</td>
...
<input type="hidden" name="action" value="show" id="action">
  <tr align="center">
    <td class="tablerow"><input name="fid" type="text" size="15" value="<?=$minmovieid?>"></td>
    <td class="tablerow"><input name="tid" type="text" size="15" value="<?=$maxmovieid?>"></td>
    <td class="tablerow"><input name="pernum" type="text" size="15" value="100"></td>
    <td class="tablerow"><input name='submit' type='submit' value='生成影视'>&nbsp;&nbsp;<input type="submit" onClick="$('action').value='url';" value="更新地址" ></td>
  </tr>
</form>
</table>
...
<?=$categorys?>
  <tr>
	...
	<input type="submit" name="submit2" value="生成影视" onClick="document.myform.action='?mod=<?=$mod?>&file=<?=$file?>&action=cat_show&channelid=<?=$channelid?>'">&nbsp;&nbsp;
