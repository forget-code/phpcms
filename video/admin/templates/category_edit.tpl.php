...
<caption>修改栏目</caption>
<tr>
  <th width='25%'><strong>上级栏目</strong></th>
  <td>
<?=form::select_category($mod, 0, 'category[parentid]', 'parentid', '无（作为一级栏目）', $parentid)?>  <font color="red">*</font>
  </td>
  </tr>
    <tr>
      <th><strong>栏目名称</strong></th>
      <td><input name='category[catname]' type='text' id='catname' value='<?=$catname?>' size='40' maxlength='50' require="true" datatype="limit|ajax" min="1" max="50" url="?mod=video&file=category&action=checkname&parentid=<?=$catid?>" msg="字符长度范围必须为1到50位|" msgid="msgid1"> <?=form::style('category[style]',$style)?>  <font color="red">*</font><span id ="msgid1"/></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><textarea name='category[description]' id='description' cols='60' rows='4'><?=$description?></textarea></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><textarea name='setting[meta_keywords]' cols='60' rows='3' id='meta_keywords'><?=$meta_keywords?></textarea></td>
    </tr>
    <tr>
      <th><strong>META Description（栏目描述）</strong><br/>针对搜索引擎设置的网页描述</th>
      <td><textarea name='setting[meta_description]' cols='60' rows='3' id='meta_description'><?=$meta_description?></textarea></td>
    </tr>
	   <tr>
      <th width='30%'><strong>栏目页模板</strong></th>
      <td><?=form::select_template($mod, 'setting[template_category]', 'template_category', "$template_category", "",'category')?></td>
    </tr>
    <tr>
      <th><strong>列表页模板</strong></th>
      <td><?=form::select_template($mod, 'setting[template_list]', 'template_list',"$template_list", "",'list')?></td>
    </tr>
    <tr>
      <th><strong>内容页模板</strong></th>
      <td><?=form::select_template($mod, 'setting[template_show]', 'template_show',"$template_show", '','show')?></td>
    </tr>
    <tr>
      <th><strong>打印页模板</strong></th>
      <td><?=form::select_template($mod, 'setting[template_print]', 'template_print', '', '','print')?></td>
    </tr>
  </table>
