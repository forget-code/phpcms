...
<?=$category_select?>
    ...
    <tr> 
      <td class="tablerow"><b>多少天以内的产品</b></td>
...
您可以从下拉框中选择
    ...
    <tr> 
      <td class="tablerow"><b>产品排序方式</b></td>
      <td  class="tablerow">
<select name="tag_config[ordertype]">
<option value="0">按产品排序排序</option>
...
<option value="10">10列</option>
  ...
  <td  class="tablerow"><input name="tag_config[username]" id="username" type="text" size="15" /> 可调用单个会员的产品</td>
</tr>
