...
<table cellpadding="2" cellspacing="1" class="tableborder">
  <tr>
    <th colspan=2>添加自定义网页</th>
  </tr>
  <form name="myform" id="myform" method="post" action="?mod=<?=$mod?>&file=<?=$file?>&action=<?=$action?>" onsubmit="return doCheck();">
    <tr> 
      <td width="30%" class="tablerow"><b>名称</b><font color="red">*</font>
	  <br>必须由英文字母、数字和下划线组成
	  </td>
      <td width="70%" class="tablerow"><input name="name" type="text" size="30"></td>
    </tr>
    <tr> 
      <td class="tablerow"><b>网页标题</b><font color="red">*</font><br>将显示到浏览器标题栏，所有搜索引擎均重视此项内容</td>
      <td class="tablerow"><input name="seo_title" type="text" size="60" ><br>如果不设置则系统以标题代替此项</td>
    </tr>
    <tr> 
      <td class="tablerow"><b>网页关键词</b><br>不显示，部分搜索引擎重视此项内容</td>
      <td class="tablerow"><input name="seo_keywords" type="text" size="60" ><br>如果不设置则系统以网站关键词代替此项</td>
    </tr>
    <tr> 
      <td class="tablerow"><b>网页描述</b><br>不显示，GOOGLE搜索重视此项内容</td>
      <td class="tablerow"><input name="seo_description" type="text" size="60"><br>如果不设置则系统以网站描述代替此项</td>
    </tr>
    <tr> 
