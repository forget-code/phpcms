...
?>
  <tr bgcolor="<?=$info['bgcolor']?>" >
    ...
    <td align="center">
	<a href="?mod=<?=$mod?>&file=<?=$file?>&action=<?=$action?>&pre=<?=$info['pre']?>&submit=1">导入</a> | 
...
?>
  <tr>
	...
	<option value="utf-82utf8">GBK 转 UTF-8</option>
	<option value="utf82utf-8">UTF-8 转 GBK</option>
	<option value="big52utf8">BIG5 转 UTF-8</option>
	<option value="utf82big5">UTF-8 转 BIG5</option>
	<option value="utf-82big5">简体中文 转 繁体中文</option>
	<option value="big52utf-8">繁体中文 转 简体中文</option>
	</select>
...
<input type="checkbox" name="filenames[]" value="<?=$other['filename']?>">
    ...
    <td class="tablerow" align="center">
	<a href="?mod=<?=$mod?>&file=<?=$file?>&action=<?=$action?>&filename=<?=$other['filename']?>&submit=1">导入</a> | 
