...
?>
	...
	<td>
	  <a href='<?=ip_url($comment['ip'])?>' title="点击查看IP">IP</a> | <a href="<?=$comment['url']?>" target='_blank' title="该评论所属文章">原文</a> | <a href='?mod=comment&file=comment&keyid=<?=$comment['keyid']?>' title="与该评论所属文章相同的评论">相关评论</a>
	</td>
	</tr>
<?
}
