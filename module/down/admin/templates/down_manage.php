...
?>
    ...
    <tr align="center" onMouseOut="this.style.backgroundColor='#F1F3F5'" onMouseOver="this.style.backgroundColor='#BFDFFF'" bgcolor="#F1F3F5"> 
      <td><input name="downid[]" id="down<?php echo $down['downid']; ?>" type="checkbox" value="<?php echo $down['downid']; ?>" ></td>
      ...
      <td align="left" onMouseDown="document.getElementById('down<?php echo $down['downid']; ?>').checked = (document.getElementById('down<?php echo $down['downid']; ?>').checked ? false : true);">  
	  <a href="<?php echo $down['url']; ?>" title="<?php echo $down['atitle']; ?>" target="_blank"><?php echo $down['title']; ?></a>
	  <?php echo $down['property']; ?>
	  </td>
      ...
      <td onMouseDown="document.getElementById('down<?php echo $down['downid']; ?>').checked = (document.getElementById('down<?php echo $down['downid']; ?>').checked ? false : true);">
	  <a href="<?=PHPCMS_PATH?>member/member.php?username=<?=urlencode($down['username'])?>" class="member_url"><?php echo $down['username']; ?></a>	  </td>
      ...
      <td>
	  <a href="?mod=<?php echo $mod; ?>&file=<?php echo $file; ?>&action=edit&channelid=<?=$channelid?>&downid=<?php echo $down['downid']; ?>&referer=<?php echo $referer; ?>">编辑</a> | 
	  <a href="?mod=comment&file=comment&action=manage&channelid=<?php echo $channelid; ?>&item=downid&itemid=<?php echo $down['downid']; ?>&referer=<?php echo $referer; ?>">评论</a>
...
?>
  <table width="100%" border="0" cellpadding="2" cellspacing="1">
    <tr>
	  ...
	  <input name='tohtml' type="submit" value="生成信息" onClick="this.form.action='?mod=<?php echo $mod; ?>&file=tohtml&action=downtohtml&channelid=<?php echo $channelid; ?>&submit=1&referer=<? echo $referer; ?>'" >
	  <input type="submit" name="eliteall" value="推荐信息" onClick="this.form.action='?mod=<?php echo $mod; ?>&file=<?php echo $file; ?>&action=elite&value=1&channelid=<?php echo $channelid; ?>&submit=1&referer=<? echo $referer; ?>'" />
	  <input type="submit" name="elitenone" value="取消推荐" onClick="this.form.action='?mod=<?php echo $mod; ?>&file=<?php echo $file; ?>&action=elite&value=0&channelid=<?php echo $channelid; ?>&submit=1&referer=<? echo $referer; ?>'" />
	  <input type="submit" name="ontopall" value="置顶信息" onClick="this.form.action='?mod=<?php echo $mod; ?>&file=<?php echo $file; ?>&action=ontop&value=1&channelid=<?php echo $channelid; ?>&submit=1&referer=<? echo $referer; ?>'" />
	  <input type="submit" name="ontopnone" value="取消置顶" onClick="this.form.action='?mod=<?php echo $mod; ?>&file=<?php echo $file; ?>&action=ontop&value=0&channelid=<?php echo $channelid; ?>&submit=1&referer=<? echo $referer; ?>'" />
	  <input type="submit" name="torecycle" value="删除信息" onClick="if(confirm('确实要删除所选择的信息吗？')) this.form.action='?mod=<?php echo $mod; ?>&file=<?php echo $file; ?>&action=torecycle&value=1&channelid=<?php echo $channelid; ?>&submit=1&referer=<? echo $referer; ?>'" />
	  <input type="submit" name="move" value="批量移动" onClick="this.form.action='?mod=<?php echo $mod; ?>&file=<?php echo $file; ?>&action=move&channelid=<?php echo $channelid; ?>&movetype=1&referer=<? echo $referer; ?>'"/>
