...
<?=$parentid?>
  <font color="red">*</font>
    ...
    <tr>
      ...
      <td class='tablerow'>
        <input name='category[cattype]' id='cattype' type='radio' value='1' <?php if($cattype){ ?> checked <?php }else{ ?>disabled <?php } ?> onClick="HideTabTitle('',1)">
		...
		<input name='category[cattype]' id='cattype' type='radio' value='0' <?php if(!$cattype){ ?> checked <?php }else{ ?>disabled <?php } ?> onClick="HideTabTitle('none')">
