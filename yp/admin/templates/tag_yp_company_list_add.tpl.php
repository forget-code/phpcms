...
<table cellpadding="2" cellspacing="1" class="tableborder">
  ...
  <form name="myform" method="get" action="?" onsubmit="return doCheck();">
   ...
   <input type="hidden" name="tag_config[func]" value="<?=$function?>">
    ...
    <tr> 
      <td class="tablerow"><b>标签说明</b><br/>例如：首页最新推荐企业，10篇</td>
  ...
  <tr> 
      ...
      <td  class="tablerow">
<input name="tag_config[tradeid]" type="text" size="10"  id="tradeid" value="0">&nbsp;
<?=trade_select('settradeid', '不限', '', 'onchange="ChangeInput(this,document.myform.tradeid)"')?>
&nbsp;选择时区域ID会自动加入到表单中
</td>
</tr>
<tr> 
      <td class="tablerow" width="40%"><b>是否调用子行业企业</b></td>
      <td  class="tablerow"><input type="radio" name="tag_config[child]" value="1" checked>是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="tag_config[child]" value="0">否</td>
    </tr>
    <tr> 
	...
	<tr> 
      ...
      <td  class="tablerow"><input type="radio" name="tag_config[vip]" value="1" >是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="tag_config[vip]" value="0" checked>否</td>
    </tr>
    <tr> 
      <td class="tablerow"><b>调用企业数或每页企业数</b></td>
      <td  class="tablerow"><input name="tag_config[number]" type="text" size="10" value="10"></td>
    </tr>
    <tr> 
      <td class="tablerow"><b>企业简介最大字符数</b></td>
      <td  class="tablerow"><input name="tag_config[length]" type="text" size="10" value="0"> 设置为0 则不调用简介</td>
    </tr>
	<tr> 
      <td class="tablerow"><b>调用所属经营模式</b></td>
      <td  class="tablerow"><input name="tag_config[pattern]" type="text" size="10" value="0" id="pattern"><?=$pattern_select?></td>
    </tr>
    <tr style="display:none"> 
      <td class="tablerow"><b>推荐位置</b></td>
      <td  class="tablerow"><?=pos_select($mod, "tag_config[posid]", "不限", 0)?></td>
    </tr>
    <tr> 
      <td class="tablerow"><b>注册多少天以内的企业</b></td>
...
您可以从下拉框中选择
    ...
    <tr> 
      <td class="tablerow"><b>企业排序方式</b></td>
      <td  class="tablerow">
<select name="tag_config[ordertype]">
<option value="0">按企业排序排序</option>
...
<tr> 
      ...
      <td  class="tablerow"><input type="radio" name="tag_config[showcontact]" value="1" >是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="tag_config[showcontact]" value="0" checked>否</td>
    </tr>
    <tr> 
...
<option value="10">10列</option>
    ...
    <tr> 
      ...
      <td  class="tablerow">
	<?=showtpl($mod,'tag_company_list','tag_config[templateid]')?>
