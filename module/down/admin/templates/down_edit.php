...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="1" >
  <tr>
    <td>当前位置：<?php echo $headtitle; ?> &gt;&gt; <?php echo $cat_pos; ?> </td>
...
<form action="?mod=<?php echo $mod; ?>&file=down&action=edit&submit=1&channelid=<?php echo $channelid; ?>&referer=<?php echo urlencode($referer); ?>" method="post" enctype="multipart/form-data" name="myform" id="myform" onsubmit="return doCheck();">
...
<table align="center" cellpadding="2" cellspacing="1" class="tableborder">
  ...
  <tr>
    ...
    <td class="tablerow">
	<?php echo $cat_select; ?>
	<input type="hidden" name="downid" value="<?php echo $downid; ?>"/>
	</td>
  </tr>
  <tr>
  ...
  <tr>
	...
	名称 
	  <input name="copyfromname" type="text" id="copyfromname" value="<?php echo $copyfromname; ?>" size="10" maxlength="50" />
	地址 
	<input name="copyfromurl" type="text" id="copyfromurl"  value="<?php echo $copyfromurl; ?>" size="25" maxlength="200" />
  ...
  <tr>
    <td class="tablerow">简介 <font color='#FF0000'>*</font></td>
    <td class="tablerow">
...
<?php 
if(is_array($downurls))
{
      foreach($downurls as $downurl)
      {
		  echo "<option value='".$downurl."'>".$downurl."</option>\n";
      }	
}
?>
</select>
  ...
  <tr>
	...
	<input name="filesize" type="text" id="filesize" value="<?php echo $filesize; ?>" size="15" maxlength="20" /> KB</td>
	  ...
	  <select name="stars" id="stars">
          ...
          <option value="0" <?php if($stars==0) echo 'selected="selected"'; ?> >无</option>
      </select>	  </td>
    </tr>
	<tr>
	  <td class="tablerow">属性</td>
	  <td class="tablerow">
	  <input name="ontop" type="checkbox" id="ontop" value="1" <?php if($ontop==1) echo 'checked="checked"'; ?> />置顶
	  <input name="elite" type="checkbox" id="elite" value="1" <?php if($elite==1) echo 'checked="checked"'; ?> />推荐
	  </td>
    </tr>
  <tr>
...
<?}?>
  ...
  <tbody id="Tabs1" style="display:none">
	...
	<tr>
      ...
      <td class="tablerow">
	  <input name="readpoint" type="text" id="readpoint" value="<?php echo $readpoint; ?>" size="5" maxlength="10" /> 点
	  </td>
    </tr>
  </tbody>
 ...
 <tbody id="Tabs2" style="display:none">
	...
	<tr>
	  ...
	  <td class="tablerow">
	  <?php echo $skin_select; ?>
	  </td>
    </tr>
	<tr>
	  <td class="tablerow">选择模版：</td>
	  <td class="tablerow">
	  <?php echo $tpl_select; ?>
	  </td>
    </tr>
