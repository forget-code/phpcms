	  ...
	  <tr>
        ...
        <td>
			...
			?>
				  ...
				  <td align="center"><input type="checkbox" name="priv_groupid[]"  checked value="add,<?php echo $_value['groupid'];?>" ></td>
			  </tr>
			<?php }?>
			 </tbody>
			</table>
