...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			<td width="100%" align="left" valign="middle" colspan="5">访问来路为<?php echo $refurl; ?>的所有历史数据</td>
		</tr>
		<tr>
...
<?php
	$curUri .= "&refurl=" . urlencode($refurl);
} else {
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
...
?>
		<tr>
			<td width="54%" align="center" valign="middle" class="tablerowhighlight">来路URL</td>
...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			...
			<td width="8%" align="center" valign="middle"><a href="<?php echo "$curUri&refurl=" .urlencode($resault[$i][1]); ?>" target="_self">GO</a></td>
		</tr>
<?php
		}
?>
