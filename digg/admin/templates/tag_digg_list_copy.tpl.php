...
可用中文，不得包含特殊字符 ' &quot; $ { } ( ) \ / ,</span></td>
    <td width="67%" height="25" ><input name="tagname" id="tagname" type="text" size="20" value="" />
  ...
  <tr bgcolor="#F1F3F5">
    ...
    <td height="25" >是
      <label>
      <input name="tag_config[page_on]" type="radio" id="page_on" value="1" <?php if ($tag_config[page_on]==1){?> checked="checked" <?php }?> />
      </label>
      否
      <label>
