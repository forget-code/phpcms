...
<tr >
	...
	<td class="tablerow">
	<?=type_select('typeid','请选择分类')?>
	</td>
</tr>
<tr >
	<td class="tablerow" align="right">链接类型</td>
	<td class="tablerow">
	<input name="linktype" type="radio" value="1" checked="checked" style="border:0">
	Logo链接&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="radio" name="linktype" value="0"  style="border:0">
	文字链接</td>
</tr>

<tr >
	<td class="tablerow" align="right" valign="middle">网站名称</td>
	<td class="tablerow"><input name="name" size="30"  maxlength="20" >
	<font color="#FF0000"> *</font> &nbsp;<?=$style_edit?></td>
</tr>
<tr >
	<td class="tablerow" align="right">网站地址</td>
	<td class="tablerow"><input name="url" size="30"  maxlength="100" type="text" value="http://">
	<font color="#FF0000">*</font></td>
</tr>
<tr >
	<td class="tablerow" align="right">网站Logo</td>
	<td class="tablerow"><input name="logo" size="30" id='logo' maxlength="100" type="text" > 大小规格为88*31像素
...
<tr>
	...
	<td class="tablerow"><input name="username" size="30"  maxlength="20" type="text" >
	可不填</td>
</tr>
<tr >
	<td class="tablerow" align="right">网站介绍</td>
	<td valign="middle" class="tablerow"><textarea name="introduce" cols="40" rows="5" id="introduction"></textarea></td>
</tr>
<tr >
	<td class="tablerow" align="right">推荐</td>
	<td class="tablerow"><input type='radio' name='elite' value='1' > 是 <input type='radio' name='elite' value='0' checked="checked"> 否</td>
</tr>
