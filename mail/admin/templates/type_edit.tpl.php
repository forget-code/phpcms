...
<table cellpadding="0" cellspacing="1" class="table_form">
  ...
  <tr>
    ...
    <td width="75%"><input type="text" name="info[name]" value="<?=$name?>" size="30" require="true" datatype="require" msg="请填写类别名称" /> <?=form::style('info[style]', $style)?> <font color="red">*</font></td>
  </tr>
  <tr>
