...
<table cellpadding="2" cellspacing="1" class="tableborder">
  ...
  <th colspan=2>基本信息</th>
    ...
    <td width="*" class='tablerow'><textarea name="job[JobDescription]" cols="40" rows="5" id="jobJobDescription"></textarea></td>
      </tr>
  
  <th colspan=2>网址采集</th>
  <tr>
    <td width="192"  class='tablerow'><strong>起始地址:</strong>      </td>
    <td width="1024" class='tablerow'><table width="98%"  border="0">
      <tr>
        <td width="20%"><input name='StartStyle' type='radio' id='StartStyle0' onClick="addresssingle.style.display='block';addressmulti.style.display='none';addresssimilar.style.display='none';" value='0' checked>
从单一网页</td>
        <td width="20%"><input name='StartStyle' id='StartStyle1' type='radio' value='1'  onClick="addresssingle.style.display='none';addressmulti.style.display='block';addresssimilar.style.display='none';">
从多个网页</td>
        <td width="60%"><input name='StartStyle' id='StartStyle2' type='radio' value='2'  onClick="addresssingle.style.display='none';addressmulti.style.display='none';addresssimilar.style.display='block';">
从序列相似网址</td>
      </tr>
      <tr style="display:block" id="addresssingle">
        <td colspan="3">网页地址:
          <input name='SingleUrl' type='text' id='SingleUrl' value="http://" size='60'></td>
        </tr>
      <tr style="display:none" id="addressmulti">
        <td colspan="3"><table width="98%"  border="0">
          <tr>
            <td width="80">网页地址：</td>
            <td width="40%"><textarea name="MultiUrl" id="MultiUrl" cols="60" rows="6" >http://</textarea></td>
            <td width="*">(一行一个）</td>
          </tr>
        </table></td>
        </tr>
      <tr  style="display:none" id="addresssimilar">
        <td colspan="3"><input name='SimilarUrl' type='text' id='SimilarUrl' value="http://" size='60'>
          &nbsp;通配符: <a href="javascript:AddOnPos(document.myform.SimilarUrl,'(*)');"  style="color:#3300FF;">(*)</a> <br>
通配符范围: 从
<input name='StarNumStart' type='text' id='StarNumStart' size='4'>
到
<input name='StarNumEnd' type='text' id='StarNumEnd' size='4'>
&nbsp;&nbsp;&nbsp;&nbsp;步长倍数:
...
&nbsp;&nbsp;&nbsp;网址中不得包含
  ...
  <tr>
    ...
    <td class='tablerow'><table width="98%"  border="0">
        <tr>
          <td width="628">从
            <textarea name="job[ListUrlStart]" cols="30" rows="5" id="textarea2"></textarea>
到
<textarea name="job[ListUrlEnd]" cols="30" rows="5" id="textarea3"></textarea></td>
...
echo <<<EOT
  <tr bgcolor="#CCFFCC">
    <td colspan="2"  style="cursor:hand" onClick="ShowLabel('{$label["name"]}');"><table width="100%"  border="0">
        <tr>
          <td width="78%"><img src="{$ph}images/icon/{$label["imgstatus"]}.gif" width="18" height="18" id="{$label["name"]}img">
...
<tr bgcolor="#CCFFCC">
    <td colspan="2"  style="cursor:hand" onClick="ShowLabel('${"label_".$labelkeys[$k]}');"><table width="100%"  border="0">
        <tr>
          <td width="78%"><img src="{$ph}images/icon/open.gif" width="18" height="18" id="${"label_".$labelkeys[$k]}img">
...
通配符:<a href="javascript:AddOnPos(document.myform.jobDividePageEnd,'(*)');" style="color:#3300FF;">(*)</a>
  ...
  <tr>
    ...
    <td class='tablerow'><input type="checkbox" name="job[DownImg]" id="jobDownImg" value="0">
 ...
 <tr>
    ...
    <td class='tablerow'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    线程数:<input name='job[ThreadNum]' type='text' id='jobThreadNum' size='8' value='2'><br />
    每个线程同时请求连接数:<input name='job[ThreadRequest]' type='text' id='jobThreadRequest' size='8'  value='2'><br />
    线程间隔时间(单位为秒):<input name='job[ThreadSleep]' type='text' id='jobThreadSleep' size='8' value='0'><br /></td>
  </tr>
   <tr>
