...
<?=$category_select?></span> &nbsp;选择时栏目ID会自动加入到表单中
   ...
   <tr> 
      ...
      <td  class="tablerow"><input type="radio" name="tag_config[thumbtype]" value="1" >大缩略图&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="tag_config[thumbtype]" value="0" checked>小缩略图</td>
    </tr>
    <tr> 
...
<span id="selectspecialid">
    ...
    <tr> 
      ...
      <td  class="tablerow"><input name="tag_config[movienum]" type="text" size="10" value="5"></td>
    </tr>
    <tr> 
...
<option value='23' >随机任意的上述一种效果</option>
  ...
  <td  class="tablerow"><input name="tag_config[username]" id="username" type="text" size="15" /> 可调用单个会员的文章</td>
    ...
    <tr> 
      ...
      <td  class="tablerow">
	<?=showtpl($mod,'tag_movie_slide','tag_config[templateid]',0,'id="templateid"')?>
