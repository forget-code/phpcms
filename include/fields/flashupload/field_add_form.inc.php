<table cellpadding="2" cellspacing="1" onclick="javascript:$('#minlength').val(0);$('#maxlength').val(255);">
	<tr> 
      <td>允许上传的视频大小</td>
      <td><input type="text" name="setting[upload_maxsize]" value="1024" size="5">KB 提示：1KB=1024Byte，1MB=1024KB *<br />服务器允许的最大上传附件为<font color="red"><?=ini_get('upload_max_filesize')?></font>，你所设的值需小于或等于<font color="red"><?=ini_get('upload_max_filesize')?></font></td>
    </tr>
	<tr> 
      <td>允许上传视频类型</td>
