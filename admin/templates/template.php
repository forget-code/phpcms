...
<table cellpadding="0" cellspacing="0" border="0" width="100%" height="30">
  <tr>
    <td>当前位置：<a href="?mod=phpcms&file=templateproject&action=manage">模板方案管理</a> > <a href="?mod=phpcms&file=template&action=manage&project=<?=$project?>&module=<?=$module?>"><?=$projectname?> - <?=$_MODULE[$module][modulename]?> 模板管理</a></td>
  </tr>
</table>
