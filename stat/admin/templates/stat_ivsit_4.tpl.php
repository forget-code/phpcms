...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			<td width="100%" align="left" valign="middle" colspan="5">搜索关键词为<?php echo $keyword; ?>的所有历史数据</td>
		</tr>
		<tr>
...
<?php
	$curUri .= "&keyword=" . urlencode($keyword);
} else {
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
...
?>
		<tr>
			<td width="30%" align="center" valign="middle" class="tablerowhighlight">搜索关键词</td>
...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			...
			<td width="8%" align="center" valign="middle"><a href="<?php echo "$curUri&keyword=" . urlencode($resault[$i][1]); ?>" target="_self">GO</a></td>
		</tr>
<?php
		}
?>
