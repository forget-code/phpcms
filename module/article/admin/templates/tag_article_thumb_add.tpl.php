...
<?=$category_select?>
    ...
    <tr> 
      <td class="tablerow"><b>调用文章数或每页文章数</b></td>
    ...
    <tr> 
      ...
      <td  class="tablerow"><input name="tag_config[typeid]" type="text" size="5" value="0" id="typeid"> <?=type_select('', '请选择', 0, 'onchange="$(\'typeid\').value=this.value"')?></td>
    </tr>
    <tr> 
...
您可以从下拉框中选择
    ...
    <tr> 
      <td class="tablerow"><b>文章排序方式</b></td>
      <td  class="tablerow">
...
<option value="10">10列</option>
  ...
  <td  class="tablerow"><input name="tag_config[username]" id="username" type="text" size="15" /> 可调用单个会员的文章</td>
    ...
    <tr> 
      ...
      <td  class="tablerow">
	<?=showtpl($mod,'tag_article_thumb','tag_config[templateid]',0,'id="templateid"')?>
