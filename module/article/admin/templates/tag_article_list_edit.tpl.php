...
?>
    ...
    <tr> 
      <td class="tablerow"><b>是否调用子栏目文章</b></td>
    ...
    <tr> 
      ...
      <td  class="tablerow"><input name="tag_config[typeid]" type="text" size="10" value="<?=$tag_config['typeid']?>" id="typeid"> <?=type_select('typeid', '请选择', 0, 'onchange="$(\'typeid\').value=this.value"')?></td>
    </tr>
    ...
    <tr> 
      <td class="tablerow"><b>多少天以内的文章</b></td>
...
<option value='0' <? if($tag_config['ordertype']==0) { ?>selected<? } ?>>按文章排序排序</option>
