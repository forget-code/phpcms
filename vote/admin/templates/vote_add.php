...
<form method="post" name="myform" action="?mod=vote&file=vote&action=add&channelid=<?=$channelid?>">
          <tr>
		 ...
		 <font color="#FF0000"> *</font></td>
		  ...
		  <tr>
            ...
            <td class="tablerow">
<script language=javascript>var dateFrom=new MyCalendar("fromdate","<?=$today?>","选择,年,月,日,上一年,下一年,上个月,下个月,一,二,三,四,五,六"); dateFrom.display();</script>
                <font color="#FF0000">*</font> 格式：yyyy-mm-dd</td>
          </tr>
          <tr>
            <td class="tablerow" align="left">截止日期</td>
            <td class="tablerow">
<script language=javascript>var dateFrom=new MyCalendar("todate","","选择,年,月,日,上一年,下一年,上个月,下个月,一,二,三,四,五,六"); dateFrom.display();</script>
