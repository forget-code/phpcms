...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			<td width="100%" align="left" valign="middle" colspan="5">访问者显示器颜色为<?php echo $color; ?> bit的所有历史数据</td>
		</tr>
		<tr>
...
?>
		<tr>
			<td width="30%" align="center" valign="middle" class="tablerowhighlight">显示器颜色</td>
...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			<td width="30%" align="center" valign="middle"><?php echo $resault[$i][1]; ?> bit</td>
			...
			<td width="8%" align="center" valign="middle"><a href="<?php echo "$curUri&color=" . urlencode($resault[$i][1]); ?>" target="_self">GO</a></td>
		</tr>
<?php
		}
?>
