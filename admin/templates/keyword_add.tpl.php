...
<form action="?mod=<?=$mod?>&file=<?=$file?>&action=<?=$action?>" method="post" name="myform">
	...
	<tr> 
      ...
      <td><input type="text" name="info[tag]" size="30" maxlength="20" require="true" datatype="limit" min="2" max="20" msg="不得少于2个字符超过20个字符" msgid="tag_notice"> <?=form::style('info[style]',  $style)?><span id="tag_notice"></span></td>
    </tr>
	<tr> 
