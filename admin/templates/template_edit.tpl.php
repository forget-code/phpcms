...
<table cellpadding="0" cellspacing="0" border="0" width="100%" height="20">
  <tr>
    <td>当前位置：<a href="?mod=phpcms&file=templateproject&action=manage">模板方案管理</a> > <a href="?mod=phpcms&file=template&action=manage&project=<?=$project?>&module=<?=$module?>"><?=$projectname?> - <?=$MODULE[$module]['name']?> 模板管理</a> > 修改模板</td>
  </tr>
</table>
<table cellpadding="2" cellspacing="1" class="tableborder">
  <tr>
    <th colspan=2>修改模板</th>
  </tr>
...
<td class="tablerow"><font color="blue">./templates/<?=$project?>/<?=$module?>/<?=$filename?></font> (上次修改时间：<?=$filemtime?>) <font color="red">*</font></td>
</tr>
<tr>
<td class="tablerow">模板名称</td>
<td class="tablerow"><input type="text" name="templatename" value="<?=$templatename?>" size=25> 可以是中文</td>
</tr>
<tr>
...
<textarea id='txt_ln' rows='30' cols='4' align="left" style='overflow:hidden;border-right:0px;padding-right:0px;text-align:right;scrolling:no;height:320px;font-family:Fixedsys,verdana,宋体;font-size:12px;color:#0000FF;background-color:#eeeeee;' readonly>
1
2
3
4
...
<textarea id='txt_main' name='content' onscroll='show_ln()' align="left" wrap='off' style='width:750px;height:320px;overflow:auto;scrolling:yes;border-left:0px;font-family:Fixedsys,verdana,宋体;font-size:12px;'>
