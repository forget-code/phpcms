...
<option value="8">按卖出次数升序</option>
	...
	<option value="6">格式：<?=date("Y-m-d H:i",$PHP_TIME)?></option>
     ...
     <tr> 
      <td class="tablerow"><b>是否显示商品名称标题</b></td>
    ...
    <tr> 
     ...
     <tr> 
      ...
      <td  class="tablerow"><input type="radio" name="tag_config[showmarketprice]" value="1" checked>是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="tag_config[showmarketprice]" value="0">否</td>
    </tr>
    <tr> 
      <td class="tablerow"><b>是否显示更新时间、点击数等提示信息</b></td>
    ...
    <tr> 
      ...
      <td  class="tablerow"><input type="radio" name="tag_config[showcartlink]" value="1" checked>是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="tag_config[showcartlink]" value="0">否</td>
    </tr>
    <tr> 
      <td class="tablerow"><b>是否在展示列表时显示查看商品连接</b></td>
      <td  class="tablerow"><input type="radio" name="tag_config[showviewlink]" value="1" checked>是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="tag_config[showviewlink]" value="0">否</td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td  class="tablerow"><input name="tag_config[cols]" type="text" size="5" id="cols" value="3" />&nbsp;<select name="selectcols" onchange="$('cols').value=this.value" />
...
<option value="10">10列</option>
    ...
    <tr> 
      ...
      <td  class="tablerow">
		...
		<?=showtpl($mod,'tag_product_thumb','tag_config[templateid]',0,' id="templateid" ')?>
