...
<form action="?mod=<?=$mod?>&file=<?=$file?>&action=<?=$action?>&posid=<?=$posid?>" method="post" name="myform">
    <caption>修改推荐位</caption>
	<tr> 
      <th><font color="red">*</font> <strong>推荐位名称</strong></th>
      <td><input type="text" name="info[name]" value="<?=$name?>" size="30" require="true" datatype="limit" min="2" max="30" msg="不得少于2个字符超过30个字符"></td>
    </tr>
	<tr> 
