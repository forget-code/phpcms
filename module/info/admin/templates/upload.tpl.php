...
<script type="text/javascript">
  ...
  <tr>
	...
	<tr>
	<td class="tablerow">
	说明：<input type="text" name="note" size="20" value="信息地址">
...
<script type="text/javascript">
  ...
  <tr>
    <td class="tablerow">
		...
		<tr>
		<td class="tablerow">说明：<input type="text" name="note" size="15"  value="信息地址"> 地址：<input type="text" name="url" size="40" value="http://" title="必须是文件真实地址" id="url" onclick="if(this.value=='http://') this.value='';">
		<input type="checkbox" name="rename" value="1" checked> 重命名
  ...
  <tr>
    <td class="tablerow">
		...
		<span title="第<?=$i?>个">说明：<input type="text" name="note[]" size="15" value="信息地址<?=$i?>"> <input type="file" name="uploadfile[]" size="15"></span><br/>
		<?php } ?>
		</td>
