...
$submenu = array(
	array('文章列表调用','?mod='.$mod.'&file='.$file.'&action=manage&func=articlelist&channelid='.$channelid),
	array('图片文章调用','?mod='.$mod.'&file='.$file.'&action=manage&func=picarticle&channelid='.$channelid),
	array('文章幻灯片调用','?mod='.$mod.'&file='.$file.'&action=manage&func=slidepicarticle&channelid='.$channelid),
...
$funcs = array('articlelist'=>'文章列表调用标签','picarticle'=>'图片文章调用标签','slidepicarticle'=>'幻灯片效果调用标签');
