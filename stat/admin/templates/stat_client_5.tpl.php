...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			<td width="100%" align="left" valign="middle" colspan="5"><?php if ($alexa == 1) {echo "安装有";} else {echo "未安装";} ?>Alexa工具条的访问者的所有历史数据</td>
		</tr>
		<tr>
...
?>
		<tr>
			<td width="30%" align="center" valign="middle" class="tablerowhighlight">Alexa工具条</td>
...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			<td width="30%" align="center" valign="middle"><?php if ($resault[$i][1] == 1) {echo '安装有';} else {echo '未安装';} ?>Alexa工具条</td>
			...
			<td width="8%" align="center" valign="middle"><a href="<?php echo "$curUri&alexa=" . urlencode($resault[$i][1]); ?>" target="_self">GO</a></td>
		</tr>
<?php
		}
?>
