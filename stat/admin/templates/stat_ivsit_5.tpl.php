...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			<td width="100%" align="left" valign="middle" colspan="5">地理位置为<?php echo $province; ?>的所有历史数据</td>
		</tr>
		<tr>
...
<?php
		$curUri .= "&province=" . urlencode($province);
} else {
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
...
?>
		<tr>
			<td width="30%" align="center" valign="middle" class="tablerowhighlight">地理位置</td>
...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			...
			<td width="8%" align="center" valign="middle"><a href="<?php echo "$curUri&province=" . urlencode($resault[$i][1]); ?>" target="_self">GO</a></td>
		</tr>
<?php
		}
?>
