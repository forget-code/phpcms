...
<td align="center"><input type="text" name="price[<?=$id?>]" value="<?=$time['price']?>" size="10"> 分</td>
</tr>
<?php 
	}
?>
...
<td align="center"><input type="text" name="newprice" size="10"> 分</td>
</tr>
</table>
...
<table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<td>
	<input name="dosubmit" type="submit" value=" 更新积分兑换有效期设置 " />
	</td>
  </tr>
</table>
</form>
