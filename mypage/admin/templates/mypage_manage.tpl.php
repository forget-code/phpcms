...
<table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td>&nbsp;&nbsp;
		<input type="submit"  value="删除选定的自定义网页" onClick="document.myform.action='?mod=<?=$mod?>&file=<?=$file?>&action=delete';">&nbsp;&nbsp;
     </td>
  </tr>
</table>
</form>
...
<table cellpadding="2" cellspacing="1" border="0" align="center" class="tableBorder" >
  ...
  <tr>
    <td class="tablerow">
<font color="blue">请先添加一个网页模板</font>，<font color="red">命名类似为mypage-1.html、mypage-2.html</font>，然后再添加自定义网页并套用该模板。<br>
