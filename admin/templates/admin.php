...
<td><?=$a['truename']?></td>
<td><?=$admingrades[$a['grade']]?></td>
<td><?=$a['lastloginip']?></td>
<td><?=$a['lastlogintime']?></td>
<td><?=$a['logintimes']?></td>
<td><a href='?mod=<?=$mod?>&file=<?=$file?>&action=edit&userid=<?=$a['userid']?>'>修改权限</a> | <a href='?mod=phpcms&file=admin&action=delete&userid=<?=$a['userid']?>'>撤消</a></td>
</tr>
<?php 
	}
}
