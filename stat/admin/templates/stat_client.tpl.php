...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			<td width="100%" align="left" valign="middle" colspan="5">访问者操作系统为<?php echo $osys; ?>的所有历史数据</td>
		</tr>
		<tr>
...
?>
		<tr>
			<td width="30%" align="center" valign="middle" class="tablerowhighlight">操作系统</td>
...
?>
		<tr onmouseover="this.className='trbg2';" onmouseout="this.className='trbg1';">
			...
			<td width="8%" align="center" valign="middle"><a href="<?php echo "$curUri&osys=" . urlencode($resault[$i][1]); ?>" target="_self">GO</a></td>
		</tr>
<?php
		}
?>
