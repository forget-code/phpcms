...
<table width="100%" height="25" border="0" cellpadding="3" cellspacing="0" class="tableborder">
  <tr>
    <td class="tablerow"> <img src="<?=PHPCMS_PATH?>admin/skin/images/pos.gif" align="absmiddle" alt="当前位置" > 当前位置：<a href="?mod=<?=$mod?>&file=<?=$file?>&action=manage">企业产品首页</a> &gt;&gt; <a href="?mod=<?=$mod?>&file=<?=$file?>&action=manage&job=manage">审核产品</a>  </td>
...
<?php if($product['label']==1){ ?> <font color="blue">[求]</font><?php } elseif($product['label']==2) {?> <font color="blue">[二]</font><?php } elseif($product['label']==3) {?> <font color="blue">[促]</font><?php } ?>
</td>
