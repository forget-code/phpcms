      ...
      <tr>
		...
		<tr>
              <td>
               <table width="100%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#183789">
                  <tr>
                    <th class="white"><img src="<?=PHPCMS_PATH?>admin/skin/images/on.gif" width="20" height="9"><a href="?mod=<?=$mod?>&file=article&action=main&channelid=<?=$channelid?>"  target="right"><?=$CHA['channelname']?>首页</a></td>
                  </tr>
                  ...
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=<?=$file?>&action=main&channelid=<?=$channelid?>"  target="right"><font color="red">添加文章</font></a></td>
                  </tr>

                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=<?=$file?>&action=manage&channelid=<?=$channelid?>"  target="right">管理文章</a></td>
                  </tr>
				  </table>
			</td>
			</tr>
              ...
              <td>
               <table width="100%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#183789">
                 ...
                 <TBODY style="display:" id="setting">
				  ...
				  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=phpcms&file=type&action=manage&keyid=<?=$channelid?>" target="right">附属分类管理</a></td>
                  </tr>
				  <tr>
				  ...
				  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=phpcms&file=keywords&keyid=<?=$channelid?>" target="right">关键字管理</a></td>
                  </tr>
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=phpcms&file=author&keyid=<?=$channelid?>" target="right">作者管理</a></td>
                  </tr>
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=phpcms&file=copyfrom&keyid=<?=$channelid?>" target="right">来源管理</a></td>
                  </tr>
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=phpcms&file=reword&keyid=<?=$channelid?>" target="right">字符过滤</a></td>
                  </tr>
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=phpcms&file=keylink&keyid=<?=$channelid?>" target="right">关联链接</a></td>
                  </tr>
                </tbody>
              </table>
           </td>
              ...
              <td>
               <table width="100%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#183789">
                 ...
                 <TBODY style="display:" id="advance">
				  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=txtdata&channelid=<?=$channelid?>" target="right">文本数据管理</a></td>
                  </tr>
				  <tr>
				  ...
				  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=tag&channelid=<?=$channelid?>" target="right"><font color=blue>标签调用管理</font></a></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=phpcms&file=field&action=manage&channelid=<?=$channelid?>&tablename=<?=$CONFIG['tablepre']?>article_<?=$channelid?>" target="right">自定义字段</a></td>
                  </tr>
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=import&action=manage&channelid=<?=$channelid?>" target="right">文章数据导入</a></td>
                  </tr>
                </tbody>
              </table>
           </td>
...
<script type="text/javascript">
parent.frames['right'].location = '?mod=article&file=article&action=main&channelid=<?=$channelid?>';
</script>
</body>
</html>