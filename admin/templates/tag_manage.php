...
<table cellpadding="2" cellspacing="1" border="0" align=center class="tableBorder" >
  <tr>
    <td class="submenu" align=center><?=$funcs[$func]?>管理</td>
  </tr>
  <tr>
...
<td align="left">
短标签：<input type='text' value="{$tag[<?=$tag[tag]?>]}" size='80' name='tag<?=$tag[tagid]?>a' onfocus="document.myform.elements['tag<?=$tag[tagid]?>a'].select();"><br/>
...
JS调用：<input type='text' value="<script language='javascript' src='<?=$PHP_SITEURL?><?=($channelid ? $_CHA[channeldir]."/" : "")?>js.php?tag=<?=$tag[tag]?>'></script>" size='80' name='js<?=$tag[tagid]?>' onfocus="document.myform.elements['js<?=$tag[tagid]?>'].select();">
</td>
