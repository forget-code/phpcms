...
<th colspan=3>促销信息发布</th>
 <tr> 
      <td width="19%" class="tablerow">所属栏目</td>
      <td class="tablerow"><font color="#FF0000"><?=trade_select('product[catid]', '请选择所属栏目','',"id='catid'")?></font> </td>
    </tr>
<tr> 
...
<tr>
      ...
      <td class="tablerow"><input name="product[formerprice]" type="text" id="formerprice" size="10" > 元
</td>
</tr>
<tr> 
	<td class="tablerow">信息图片</td>
	<td class="tablerow" title="如果设置信息图片，则可以在首页以及栏目页以图片方式链接到信息"><input name="product[thumb]" type="text" id="thumb" size="53">  <input type="button" value="上传图片" onclick="javascript:openwinx('<?=$SITEURL?>/upload.php?keyid=yp&uploadtext=thumb&type=thumb&width=150&height=150','upload','350','350')">
	</td>
</tr>
<tr> 
<td class="tablerow">促销说明</td>
<td valign="top" class="tablerow">
<textarea name="product[state]" id="state" cols="100" rows="7"></textarea>
</td>
</tr>
<tr> 
<td class="tablerow">信息说明</td>
<td valign="top" class="tablerow">
<textarea name="product[introduce]" id="introduce" cols="100" rows="15"> </textarea> <?=editor("introduce", 'phpcms','100%','260')?>
</td>
</tr>
<tr> 
...
<table width="100%" align="center" cellpadding="2" cellspacing="1" >
  <tr>
	...
	<input type="hidden" name="labelfile" value="sales" />
	<input type="submit" name="dosubmit" value=" 发布促销信息 " />
	</td>
  </tr>
</table>
</form>
