...
<table cellpadding="2" cellspacing="1" class="tableborder">
  ...
  <form name="myform" method="get" action="?" onsubmit="return doCheck();">
   ...
   <input type="hidden" name="tag_config[func]" value="<?=$function?>">
    ...
    <tr> 
      <td class="tablerow"><b>标签说明</b><br/>例如：首页最新推荐求购，10篇</td>
...
您可以从下拉框中选择
	    ...
	    <tr> 
      <td class="tablerow"><b>求购排序方式</b></td>
      <td  class="tablerow">
		<select name="tag_config[ordertype]">
		<option value="0">按求购排序排序</option>
    ...
    <tr> 
      <td class="tablerow"><b>是否在求购标题前显示栏目名称</b></td>
...
<option value="10">10列</option>
 ...
 <tr> 
  ...
  <td  class="tablerow"><input name="tag_config[username]" id="username" type="text" size="15" /> 可调用单个会员的求购</td>
</tr>

    <tr> 
      <td class="tablerow"><b>此标签调用的模板</b></td>
      <td  class="tablerow">
	<?=showtpl($mod,'tag_buy_list','tag_config[templateid]')?>
