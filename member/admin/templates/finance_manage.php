...
<td class=forumrow><a href="<?=PHPCMS_PATH?>member/member.php?username=<?=urlencode($finance[username])?>" target="_blank"><?=$finance[username]?></a></td>
...
<td class=forumrow><a href="<?=PHPCMS_PATH?>member/member.php?username=<?=urlencode($finance[inputer])?>" target="_blank"><?=$finance[inputer]?></a></td>
