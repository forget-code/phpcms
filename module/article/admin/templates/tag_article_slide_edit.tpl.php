...
?>
    ...
    <tr> 
      ...
      <td  class="tablerow"><input name="tag_config[typeid]" type="text" size="5" value="<?=$tag_config['typeid']?>" id="typeid"> <?=type_select('', '请选择', 0, 'onchange="$(\'typeid\').value=this.value"')?></td>
    </tr>
    <tr> 
