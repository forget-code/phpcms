      ...
      <tr>
		...
		<tr>
              <td>
               <table width="100%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#183789">
                  <tr>
                    <th class="white"><img src="<?=PHPCMS_PATH?>admin/skin/images/on.gif" width="20" height="9"><a href="?mod=<?=$mod?>&file=info&action=main&channelid=<?=$channelid?>"  target="right"><?=$CHA['channelname']?>首页</a></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=<?=$file?>&action=main&channelid=<?=$channelid?>"  target="right"><font color="red">添加信息</font></a></td>
                  </tr>

                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=<?=$file?>&action=manage&channelid=<?=$channelid?>"  target="right">管理信息</a></td>
                  </tr>
				  </table>
			</td>
			</tr>
           ...
           <?php if($_grade<2){ ?>
            ...
            <table width="100%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#183789">
				   <tr>
                    <th class="white" onclick="javascript:show('area')"><img src="<?=PHPCMS_PATH?>admin/skin/images/on.gif" width="20" height="9" id="category_img"><a href="###">地区管理</a></td>
                  </tr>

                 <tbody style="display:" id="area">
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=area&action=add&channelid=<?=$channelid?>" target="right">添加地区</a></td>
                  </tr>
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=area&action=manage&channelid=<?=$channelid?>" target="right">管理地区</a></td>
                  </tr>
                </tbody>
              </table>
              </td>
              ...
              <td>
               <table width="100%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#183789">
                 ...
                 <TBODY style="display:" id="setting">
                  ...
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=phpcms&file=reword&action=manage&keyid=<?=$channelid?>" target="right">字符过滤</a></td>
                  </tr>
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=phpcms&file=keylink&action=manage&keyid=<?=$channelid?>" target="right">关联链接</a></td>
                  </tr>
                </tbody>
              </table>
           </td>
              ...
              <td>
               <table width="100%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#183789">
				...
				<tr>
                  ...
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=phpcms&file=field&action=manage&channelid=<?=$channelid?>&tablename=<?=channel_table('info', $channelid)?>" target="right">自定义字段</a></td>
                  </tr>
                </tbody>
              </table>
           </td>
...
<script type="text/javascript">
parent.frames['right'].location = '?mod=info&file=info&action=main&channelid=<?=$channelid?>';
</script>
</body>
</html>