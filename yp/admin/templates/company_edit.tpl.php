...
function checkdomain(inputname)
{
    if(inputname==''){
        ...
        var checkurl = "<?=$PHPCMS['siteurl']?>yp/register.php";
...
//-->
  ...
  <form name="myform" method="post" action="" onSubmit='return CheckForm();'>
   ...
   <th  colspan=2>修改企业信息</th>
    <tr>
      <td width="15%" class="tablerow">公司名称：</td>
    ...
    <tr>
      ...
      <td class="tablerow"><textarea name="product" cols="50" rows="5" id="product"><?=$product?></textarea>
              <Font color="#FF0000">* 请简洁说明公司主营产品和服务内容。字数在250字以内。</Font></td>
    </tr>
	<tr>
...
?>
	<tr>
		...
		<td class="tablerow"><input name="sitedomain" type="text" id="sitedomain" value="<?=$sitedomain?>" size="25" onBlur="checkdomain(this.value);">
		.<?=$MOD['secondDomain']?> <font color="red">*</font> <span id="domain_notice"> 域名只能为 英文 数字 - 等组成，如：<font color="#ff0000">php-518</font>.<?=$MOD['secondDomain']?></span></td>
	</tr>
<?php
}
?>
...
<?=$fields?>
<tr>
      <td class="tablerow">收费有效期截止：</td>
      <td class="tablerow"><?=date_select('vip',$vip)?>
 <font color="red">*</font></td>
    </tr>
</table>
