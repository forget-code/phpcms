...
<table cellpadding="2" cellspacing="1" class="tableborder">
  ...
  <form name="myform" method="get" action="?">
   ...
   <input name="action" type="hidden" value="edit">
    ...
    <tr> 
      <td class="tablerow" width="40%"><b>标签说明</b><br/>例如：首页最新推荐信息，10篇</td>
...
?>
	...
	<tr> 
      <td class="tablerow"><b>所属地区</b></td>
      <td  class="tablerow"><input name="tag_config[areaid]" id="setareaid" type="text" size="15" value="<?=$tag_config['areaid']?>"> 
<select onchange="$('setareaid').value=this.value">
<option>请选择地区</option>
...
<?=$area_select?>
    ...
    <tr> 
      <td class="tablerow" width="40%"><b>每页信息数</b></td>
      <td  class="tablerow"><input name="tag_config[infonum]" type="text" size="10" value="<?=$tag_config['infonum']?>"></td>
    </tr>
    <tr> 
      <td class="tablerow" width="40%"><b>信息标题最大字符数</b></td>
...
您可以从下拉框中选择
    ...
    <tr> 
      <td class="tablerow" width="40%"><b>信息排序方式</b></td>
      <td  class="tablerow">
<select name='tag_config[ordertype]'>
<option value='0' <? if($tag_config['ordertype']==0) { ?>selected<? } ?>>按信息排序排序</option>
...
<option value="6" <? if($tag_config['datetype']==6) { ?>selected<? } ?>>格式：<?=date("Y-m-d H:i",$PHP_TIME)?></option>
    ...
    <tr> 
      <td class="tablerow" width="40%"><b>是否在信息标题前显示栏目名称</b></td>
    ...
    <tr> 
      <td class="tablerow" width="40%"><b>是否在标题后面显示信息浏览次数</b></td>
...
<tr> 
  ...
  <td  class="tablerow"><input name="tag_config[username]" id="username" type="text" size="15" value="<?=$tag_config['username']?>"/> 可调用单个会员的文章</td>
    ...
    <tr> 
      ...
      <td  class="tablerow">
	<?=showtpl($mod,'tag_info_list','tag_config[templateid]',$tag_config['templateid'],'id="templateid"')?>
