...
<div class="button_box">
    ...
    <input name='submit' type='submit' value='批准选定的公告' onClick="document.myform.action='?mod=announce&file=announce&action=approval&passed=1'">&nbsp;&nbsp;
