...
<table cellpadding="0" cellspacing="1" class="table_form">
	<caption>修改<?=$subject?>播放器代码</caption>
    <tr>
    	<th width="20%"><strong>名称：</strong></th>
        <td><input type="text" name="info[subject]" size="50" value="<?=$subject?>" /></td>
    </tr>
    <tr>
    	<th><strong>播放器代码：</strong></th>
        <td><textarea name="info[code]" cols="80" rows="20" style="width:100%"><?=html_entity_decode($code)?></textarea></td>
    </tr>
    <tr>
    	<th><strong>禁用：</strong></th>
        <td><?=form::radio(array(1=>'是',0=>'否'), 'info[disabled]', 'disabled', $disabled)?></td>
    </tr>
    <tr>
    	<th><strong></strong></th>
