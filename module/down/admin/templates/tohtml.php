...
?>
  <tr align=center>
    ...
    <td class="tablerow">
<a href='?mod=<?=$mod?>&file=<?=$file?>&action=category&catid=<?=$cat[catid]?>&channelid=<?=$channelid?>'>生成栏目列表</a> | 
<a href='?mod=<?=$mod?>&file=<?=$file?>&action=catdown&catid=<?=$cat[catid]?>&channelid=<?=$channelid?>'>生成下载信息</a> | 
<a href='?mod=<?=$mod?>&file=<?=$file?>&action=createcatdir&catid=<?=$cat[catid]?>&channelid=<?=$channelid?>'>生成栏目目录</a>
	</td>
  </tr>
<? } } ?>
  ...
  <tr>
	...
	<input type="submit" name="submit2" value="生成下载信息" onClick="document.myform.action='?mod=<?=$mod?>&file=<?=$file?>&action=catdown&channelid=<?=$channelid?>'">&nbsp;&nbsp;
...
<table cellpadding="2" cellspacing="1" border="0" align=center class="tableBorder" >
  <tr>
    <th colspan=4>更新下载信息</th>
  </tr>
<tr align="center">
<td width="10%" class="tablerowhighlight">下载信息起始ID</td>
<td width="45%" class="tablerowhighlight">下载信息结束ID</td>
<td width="15%" class="tablerowhighlight">每轮生成下载数</td>
<td width="30%" class="tablerowhighlight">管理操作</td>
</tr>
<form method="post" name="myform2" action="?mod=<?=$mod?>&file=<?=$file?>&action=down&channelid=<?=$channelid?>">
  <tr align=center>
    ...
    <td class="tablerow"><input name='submit' type='submit' value=' 生成html '>&nbsp;&nbsp;<a href='?mod=<?=$mod?>&file=down&action=manage&channelid=<?=$channelid?>'><b>进入下载信息管理&gt;&gt;</b></a></td>
  </tr>
</form>
</table>
<table cellpadding="0" cellspacing="0" border="0" width="100%" height="10">
