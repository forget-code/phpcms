...
<table cellpadding="2" cellspacing="1" class="tableborder">
  ...
  <form name="myform" id="myform" method="post" action="?file=mytag&action=add&channelid=<?=$channelid?>&submit=1" onsubmit="return doCheck();">
    <tr> 
      <td width="30%" class="tablerow"><b>自定义标签名</b><font color="red">*</font><br>必须由英文字母、数字和下划线组成</td>
      <td width="70%" class="tablerow"><input name="tagname" type="text" size="20"></td>
    </tr>
   <tr>
    <td class="tablerow"><b>自定义标签说明</b><br>可以用中文</td>
    <td class="tablerow"><textarea name="introduce" cols='60' rows='4'></textarea></td></tr>
    <tr> 
...
<textarea name="content" style="width: 100%; height: 400px"></textarea>
    ...
    <tr> 
      ...
      <td class="tablerow">
          <input name='passed' id='passed' type='radio' value='1' checked> 是&nbsp;&nbsp;&nbsp;&nbsp;<input name='passed' id='passed' type='radio' value='0'> 否
      </td>
    </tr>                       
    <tr> 
