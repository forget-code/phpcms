...
<td><?=$vote['addtime']?></td>
<td>
<a href='?mod=vote&file=vote&action=detail&voteid=<?=$vote['voteid']?>&keyid=<?=$keyid?>' title="统计">统计</a> | <a href='?mod=vote&file=vote&action=edit&voteid=<?=$vote['voteid']?>&keyid=<?=$keyid?>' title="编辑">编辑</a> | <a href='?mod=vote&file=vote&action=getcode&voteid=<?=$vote['voteid']?>&keyid=<?=$keyid?>' title="js调用">获取调用代码</a></td>
</tr>
<?php 
	}
 }
...
<table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td align="left">
    <?php if(!$passed){ ?><input name='submit2' type='submit' value='批准选定的投票' onClick="document.myform.action='?mod=vote&file=vote&action=pass&passed=1&keyid=<?=$keyid?>'">&nbsp;&nbsp;<?php }else{ ?>
    <input name='submit3' type='submit' value='取消批准选定的投票' onClick="document.myform.action='?mod=vote&file=vote&action=pass&passed=0&keyid=<?=$keyid?>'">&nbsp;&nbsp;<?php } ?>
    <input name="submit1" type="submit"  value="删除选定的投票" onClick="document.myform.action='?mod=vote&file=vote&action=delete&keyid=<?=$keyid?>'">&nbsp;&nbsp;
</td>
  </tr>
</table>
</form>
