...
<table cellpadding="2" cellspacing="1" class="tableborder">
  ...
  <form name="myform" method="get" action="?">
   ...
   <input name="action" type="hidden" value="edit">
    ...
    <tr> 
      <td class="tablerow" width="40%"><b>标签说明</b><br/>例如：首页最新推荐促销，10篇</td>
	...
	<tr> 
      <td class="tablerow"><b>调用所属栏目</b><br><font color="blue">多个ID之前用半角逗号隔开，0或空表示不限栏目</font><br>某些情况下可使用变量<a href="#" onclick="$('tradeid').value='$catid'"><font color="red">$catid</font></a>作为参数</td>
      <td  class="tablerow">
...
&nbsp;选择时区域ID会自动加入到表单中
    ...
    <tr> 
      <td class="tablerow"><b>是否调用子栏目促销</b></td>
    ...
    <tr> 
      <td class="tablerow"><b>多少天以内的促销</b></td>
...
您可以从下拉框中选择
    ...
    <tr> 
      <td class="tablerow" width="40%"><b>促销排序方式</b></td>
      <td  class="tablerow">
<select name='tag_config[ordertype]'>
<option value='0' <? if($tag_config['ordertype']==0) { ?>selected<? } ?>>按促销排序排序</option>
...
<option value="6" <? if($tag_config['datetype']==6) { ?>selected<? } ?>>格式：<?=date("Y-m-d H:i",$PHP_TIME)?></option>
    ...
    <tr> 
      <td class="tablerow" width="40%"><b>是否在促销标题前显示栏目名称</b></td>
...
<tr> 
  ...
  <td  class="tablerow"><input name="tag_config[username]" id="username" type="text" size="15" value="<?=$tag_config['username']?>"/> 可调用单个会员的促销</td>
</tr>

    <tr> 
      <td class="tablerow" width="40%"><b>此标签调用的模板</b></td>
      <td  class="tablerow">
	<?=showtpl($mod,'tag_sales_list','tag_config[templateid]',$tag_config['templateid'],'id="templateid"')?>
