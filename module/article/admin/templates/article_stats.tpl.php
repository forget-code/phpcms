...
<table width="100%" height="25" border="0" cellpadding="3" cellspacing="0" class="tableborder">
  <tr>
    <td class="tablerow"> <img src="<?=PHPCMS_PATH?>admin/skin/images/pos.gif" align="absmiddle" alt="当前位置" > 当前位置：<a href="?mod=<?=$mod?>&file=<?=$file?>&action=main&channelid=<?=$channelid?>">文章首页</a> &gt;&gt; 文章统计报表</td>
  </tr>
</table>
...
<td class="tablerow"><font color="red"><?php echo $sum_3+$sum_1+$sum__1+$sum_0+$sum_2; ?></font></td>
...
<td class="tablerow"><font color="red"><?=$sum_0?></font></td>
<td class="tablerow"><font color="red"><?=$sum_2?></font></td>
</tr>
</table>
