...
<td><?=$info['id']?></td>
<td><a href="<?=show_url('news',$info['id'])?>" target="_blank"><?=output::style($info['title'], $info['style'])?></a> <?=$info['thumb'] ? '<font color="red">图</font>' : ''?>&nbsp;<?=$info['elite']?'<font color="green">荐</font>': ''?></td>
<td class="align_c" ><?=$r['hits']?></td>
<td class="align_c"><a href=""><?=$info['companyname']?></td>
