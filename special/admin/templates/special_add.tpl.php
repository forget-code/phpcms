...
<table cellpadding="0" cellspacing="1" class="table_form">
	...
	<tr>
      ...
      <td><input type="text" name="info[filename]" id="filename" size="25" regexp="^[a-z0-9_]+$" require="true" datatype="limit|custom" min="1" max="50"  msg="字符长度范围必须为1到50位|只能为数字、和字母，下划线" msgid="msgid4"> <font color="#ff0000">.<?=$PHPCMS['fileext']?></font><span id="msgid4"></span></td>
    </tr>
	<tr>
