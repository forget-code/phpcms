...
<table width="100%" height="25" border="0" cellpadding="3" cellspacing="0" class="tableborder">
  <tr>
    <td class="tablerow"> <img src="<?=PHPCMS_PATH?>admin/skin/images/pos.gif" align="absmiddle" alt="当前位置" > 当前位置：<a href="?mod=<?=$mod?>&file=<?=$file?>&action=manage">企业产品首页</a> &gt;&gt; <a href="?mod=<?=$mod?>&file=<?=$file?>&action=manage&job=manage">回收站</a>  </td>
...
<table width="100%" align="center" cellpadding="2" cellspacing="1">
   <tr>
    ...
    <td>
	<input type='submit' value='清空回收站' onClick="if(confirm('确认批量删除这些产品信息吗？')) document.myform.action='?mod=<?=$mod?>&file=<?=$file?>&action=truncate'">
