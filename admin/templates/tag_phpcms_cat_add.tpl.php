  ...
  <form name="myform" method="get" action="?" onsubmit="javascript:return doCheck();">
   ...
   <input name="tag_config[func]" type="hidden" value="<?=$function?>">
    ...
    <tr> 
      ...
      <td  class="tablerow"><input name="tag_config[keyid]" id="keyid" type="text" size="15" onchange="showcat(this.value, 0)"> 
<?=keyid_select('setkeyid', '请选择模块/频道', '', 'onchange="javascript:myform.keyid.value=this.value;showcat(this.value, 0);"')?>
    ...
    <tr> 
      ...
      <td class="tablerow">
	 <input name="tag_config[catid]" id="catid" type="text" size="10" />
	<span id="category_select"></span>
	<input name='tag_config[child]' type='checkbox' value='1' checked>是否显示子栏目的下级栏目
</td>
    </tr>
    <tr> 
      <td class="tablerow" width="40%"><b>栏目显示方式</b></td>
      <td  class="tablerow"><input type="radio" name="tag_config[showtype]" value="0" checked> 树型导航菜单样式&nbsp;&nbsp;<input name='tag_config[open]' type='checkbox' value='1' checked>是否默认展开所有栏目<br>
                            <input type="radio" name="tag_config[showtype]" value="1" > <b>子栏目一</b>：下级栏目一&nbsp;|&nbsp;下级栏目二<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>子栏目二</b>：下级栏目一&nbsp;|&nbsp;下级栏目二<br>
                            <input type="radio" name="tag_config[showtype]" value="2" > <b>子栏目一</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>子栏目二</b><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;子栏目一下级&nbsp;&nbsp;子栏目一下级
    ...
    <tr> 
      ...
      <td  class="tablerow">
<?=showtpl($mod, 'tag_cat', 'tag_config[templateid]', 0 ,' id="templateid" ')?>
