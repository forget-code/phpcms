...
window.onload = function()
{
	...
	if ( FCKConfig.ImageUpload )
		//GetE('frmUpload').action = FCKConfig.Uploadfile ;
...
function Ok()
{
	...
	else
	{
		...
		var d = file_list.split('-');
		parent.parent_file_list(d);
	}
	return true ;
}
