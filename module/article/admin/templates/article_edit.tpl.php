...
<table cellpadding="2" cellspacing="1" class="tableborder">
  ...
  <tr>
    ...
    <tr> 
      ...
      <td class="tablerow"><?=$type_select?> <input name="article[title]" type="text" id="title" size="44" maxlength="100" class="inputtitle" value="<?=$title?>"> <font color="#FF0000">*</font> <?=$style_edit?> <input type="button" value="检查同名标题" onclick="Dialog('?mod=<?=$mod?>&file=<?=$file?>&action=checktitle&channelid=<?=$channelid?>&title='+$('title').value+'','','300','40','no')" style="width:90px;"></td>
    </tr>
	...
	<tr <?php if(!$MOD['keywords_show']){ ?>style="display:none"<?php } ?>> 
      ...
      <td class="tablerow"><input name="article[keywords]" type="text" id="keywords" size="40" value="<?=$keywords?>" title="提示;多个关键字请用半角逗号“,”隔开">
		<?=$keywords_select?>
