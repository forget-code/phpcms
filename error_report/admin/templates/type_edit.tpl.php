...
<table cellpadding="0" cellspacing="1" class="table_form">
  ...
  <tr>
    <th width="25%"><strong>分类名称</strong></th>
    <td width="75%"><input type="text" name="info[name]" value="<?=$name?>" size="30" require="true" datatype="require" msg="请填写类别名称" msgid="namemsg" /> <?=form::style('info[style]', $style)?> <font color="red">*</font><span id="namemsg"></span></td>
  </tr>
  <tr>
