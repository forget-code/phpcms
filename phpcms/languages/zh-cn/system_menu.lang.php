...
$LANG['template_file_edit'] = '模板文件编辑关键字';
...
$LANG['linkage'] = '联动菜单';
$LANG['special'] = '专题';
$LANG['template_editor'] = '模板编辑关键字';
$LANG['template_visualization'] = '模板可视化';
$LANG['pc_tag_edit'] = '编辑关键字PC标签';
...
$LANG['member_modelfield_edit'] = '编辑关键字会员模型字段';
...
$LANG['dbsource_edit'] = '编辑关键字外部数据源';
$LANG['dbsource_del'] = '删除外部数据源';
$LANG['dbsource_data_add'] = '添加数据源调用';
$LANG['dbsource_data_edit'] = '编辑关键字数据源调用';
