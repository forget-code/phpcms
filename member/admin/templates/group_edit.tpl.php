...
<form method="post" name="myform" onsubmit="return Check()" action="?mod=<?=$mod?>&file=<?=$file?>&action=edit&groupid=<?=$groupid?>">
  <tr>
...
<option value="special" <?php if($grouptype=='special'){ ?>selected <?php } ?>>自定义</option>
