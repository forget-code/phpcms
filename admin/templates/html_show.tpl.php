...
<form action="?" method="post" name="myform">
  ...
  <tr>
    <caption>更新内容页</caption>
  <tr>
	<th>选择栏目范围</th>
	<th>生成html</th>
  </tr>
	<tr> 
      <td align="center" rowspan="5"><?=form::select_category($mod, 0, 'catids[]', 'catids', '不限栏目', 0, ' multiple="multiple"  style="height:200px;width:250px;" title="按住“Ctrl”或“Shift”键可以多选，按住“Ctrl”可取消选择"', 2)?></td>
