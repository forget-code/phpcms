      ...
      <tr>
		...
		<tr>
              <td>
               <table width="100%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#183789">
                  <tr>
                    <th class="white"><img src="<?=PHPCMS_PATH?>admin/skin/images/on.gif" width="20" height="9"><a href="?mod=<?=$mod?>&file=picture&action=main&channelid=<?=$channelid?>"  target="right"><?=$CHA['channelname']?>首页</a></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=<?=$file?>&action=main&channelid=<?=$channelid?>"  target="right"><font color="red">添加图片</font></a></td>
                  </tr>

                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=<?=$mod?>&file=<?=$file?>&action=manage&channelid=<?=$channelid?>"  target="right">管理图片</a></td>
                  </tr>
				  </table>
			</td>
			</tr>
              ...
              <td>
               <table width="100%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#183789">
                 ...
                 <TBODY style="display:" id="setting">
                  ...
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=phpcms&file=author&action=manage&keyid=<?=$channelid?>" target="right">作者管理</a></td>
                  </tr>
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=phpcms&file=copyfrom&action=manage&keyid=<?=$channelid?>" target="right">来源管理</a></td>
                  </tr>
                  <tr>
              ...
              <td>
               <table width="100%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#183789">
				 ...
				 <tr>
                  ...
                  <tr>
                    <td height="22" bgcolor="#FFFFFF" onMouseOver="this.style.backgroundColor='#F8F8F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'"><a href="?mod=phpcms&file=field&action=manage&channelid=<?=$channelid?>&tablename=<?=channel_table('picture', $channelid)?>" target="right">自定义字段</a></td>
                  </tr>
                </tbody>
              </table>
           </td>
...
<script type="text/javascript">
parent.frames['right'].location = '?mod=picture&file=picture&action=main&channelid=<?=$channelid?>';
</script>
</body>
</html>