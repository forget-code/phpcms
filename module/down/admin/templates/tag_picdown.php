...
选择时栏目ID会自动加入到表单中
    ...
    <tr> 
      <td class="tablerow"  width="40%"><b>调用下载所属专题ID</b><br>多个ID之前用半角逗号隔开，0表示不限专题<br>某些情况下可使用变量<a href="#" onclick="myform.specialid.value='$specialid'"><font color=red>$specialid</font></a>作为参数</td>
      <td  class="tablerow">
