...
<?=$category_select?></span> &nbsp;选择时栏目ID会自动加入到表单中
	...
	<tr>
      ...
      <td  class="tablerow"><input type="radio" name="tag_config[onlythumb]" value="1" checked>是&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="tag_config[onlythumb]" value="0" >否 无小缩略图的影片不调用</td>
    </tr>
    <tr> 
...
<option value="10">10列</option>
  ...
  <td  class="tablerow"><input name="tag_config[username]" id="username" type="text" size="15" /> 可调用单个会员的文章</td>
    ...
    <tr> 
      ...
      <td  class="tablerow">
	<?=showtpl($mod,'tag_movie_thumb','tag_config[templateid]',0,'id="templateid"')?>
