...
<table width="100%" height="25" border="0" cellpadding="3" cellspacing="0" class="tableborder">
  <tr>
    <td class="tablerow"> <img src="<?=PHPCMS_PATH?>admin/skin/images/pos.gif" align="absmiddle" alt="当前位置" > 当前位置：<a href="?mod=<?=$mod?>&file=<?=$file?>&action=main&channelid=<?=$channelid?>">图片首页</a> &gt;&gt; <a href="?mod=<?=$mod?>&file=<?=$file?>&action=manage&job=recycle&catid=<?=$catid?>&channelid=<?=$channelid?>">回收站</a> &gt;&gt; <?=$cat_pos?> </td>
...
<td><?=$picture['hits']?></td>
<td>
<a href="?mod=<?=$mod?>&file=<?=$file?>&action=delete&channelid=<?=$channelid?>&pictureids=<?=$picture['pictureid']?>&referer=<?=$referer?>">删除</a> |
<a href="?mod=<?=$mod?>&file=<?=$file?>&action=action&job=status&value=3&channelid=<?=$channelid?>&pictureids=<?=$picture['pictureid']?>&referer=<?=$referer?>">还原</a>
</td>
</tr>
<? } ?>
...
<table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td>
        ...
        <input name='submit2' type='submit' value='删除图片' onClick="document.myform.action='?mod=<?=$mod?>&file=<?=$file?>&action=delete&channelid=<?=$channelid?>&referer=<?=$referer?>'" >&nbsp;
        <input name='submit3' type='submit' value='还原图片' onClick="document.myform.action='?mod=<?=$mod?>&file=<?=$file?>&action=action&job=status&value=3&channelid=<?=$channelid?>&referer=<?=$referer?>'" >&nbsp;</td>
  </tr>
</table>
