...
<td width="9%" class="tablerowhighlight">剩余天数</td>
...
<td class=forumrow><?=$member[point]?>点</td>
...
<table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td>
<input type="submit" name="submit" value="批量锁定" onClick="document.myform.action='?mod=<?=$mod?>&file=<?=$file?>&action=lock&val=1'">&nbsp;&nbsp;
<input type="submit" name="submit" value="批量解锁" onClick="document.myform.action='?mod=<?=$mod?>&file=<?=$file?>&action=lock&val=0'">&nbsp;&nbsp;
