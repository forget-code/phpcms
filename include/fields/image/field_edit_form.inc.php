<table cellpadding="2" cellspacing="1">
	...
	<tr> 
      <td>是否从已上传中选择</td>
      <td><input type="radio" name="setting[isselectimage]" value="1" <?=($isselectimage ? 'checked' : '')?>/> 是 <input type="radio" name="setting[isselectimage]" value="0" <?=($isselectimage ? '' : 'checked')?>/> 否</td>
    </tr>
	<tr> 
      <td>是否产生缩略图</td>
