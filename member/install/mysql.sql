...
DROP TABLE IF EXISTS `phpcms_member_cache`;
CREATE TABLE `phpcms_member_cache` (
...
INSERT INTO `phpcms_member_group` (`groupid`, `name`, `issystem`,  `allowmessage`, `allowvisit`, `allowpost`, `allowsearch`, `price_y`, `price_m`, `price_d`, `description`, `listorder`, `disabled`) VALUES (1, '管理员', 1, 9999, 1, 1, 1, 0.00, 0.00, 0.00, '', 0, 0);
INSERT INTO `phpcms_member_group` (`groupid`, `name`, `issystem`,  `allowmessage`, `allowvisit`, `allowpost`, `allowsearch`, `price_y`, `price_m`, `price_d`, `description`, `listorder`, `disabled`) VALUES (2, '禁用', 1,  0, 0, 0, 0, 0.00, 0.00, 0.00, '', 12, 0);
INSERT INTO `phpcms_member_group` (`groupid`, `name`, `issystem`,  `allowmessage`, `allowvisit`, `allowpost`, `allowsearch`, `price_y`, `price_m`, `price_d`, `description`, `listorder`, `disabled`) VALUES (3, '游客', 1,  0, 1, 0, 0, 0.00, 0.00, 0.00, '', 0, 0);
INSERT INTO `phpcms_member_group` (`groupid`, `name`, `issystem`,  `allowmessage`, `allowvisit`, `allowpost`, `allowsearch`, `price_y`, `price_m`, `price_d`, `description`, `listorder`, `disabled`) VALUES (4, '待邮件验证', 1,  0, 1, 0, 0, 0.00, 0.00, 0.00, '', 0, 0);
INSERT INTO `phpcms_member_group` (`groupid`, `name`, `issystem`,  `allowmessage`, `allowvisit`, `allowpost`, `allowsearch`, `price_y`, `price_m`, `price_d`, `description`, `listorder`, `disabled`) VALUES (5, '待审核', 1,  0, 1, 0, 0, 0.00, 0.00, 0.00, '', 0, 0);
INSERT INTO `phpcms_member_group` (`groupid`, `name`, `issystem`,  `allowmessage`, `allowvisit`, `allowpost`, `allowsearch`, `price_y`, `price_m`, `price_d`, `description`, `listorder`, `disabled`) VALUES (6, '注册会员', 1,  50, 1, 1, 1, 0.00, 0.00, 0.00, '', 0, 0);
...
DROP TABLE IF EXISTS `phpcms_member_group_extend`;
CREATE TABLE `phpcms_member_group_extend` (
  `userid` mediumint(8) unsigned NOT NULL default '0',
  `groupid` tinyint(3) unsigned NOT NULL default '0',
...
DROP TABLE IF EXISTS `phpcms_member_group_priv`;
CREATE TABLE `phpcms_member_group_priv` (
  `groupid` tinyint(3) unsigned NOT NULL default '0',
