<table cellpadding="2" cellspacing="1">
	...
	<tr> 
      <td>数据存储方式：</td>
      <td><input type="radio" name="setting[storage]" value="database" <?=$storage == 'database' ? 'checked' : ''?> /> 数据库存储 <input type="radio" name="setting[storage]" value="file" <?=$storage == 'file' ? 'checked' : ''?> /> 文本存储</td>
    </tr>
	<tr> 
      <td>是否启用关联链接：</td>
