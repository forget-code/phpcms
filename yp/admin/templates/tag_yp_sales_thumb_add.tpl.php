...
<table cellpadding="2" cellspacing="1" class="tableborder">
  ...
  <form name="myform" method="get" action="?" onsubmit="return doCheck();">
   ...
   <input type="hidden" name="tag_config[func]" value="<?=$function?>">
    ...
    <tr> 
      <td class="tablerow"><b>标签说明</b><br/>例如：首页最新推荐促销，10篇</td>
...
您可以从下拉框中选择
    ...
    <tr> 
      <td class="tablerow"><b>促销排序方式</b></td>
      <td  class="tablerow">
<select name="tag_config[ordertype]">
<option value="0">按促销排序排序</option>
...
<option value="10">10列</option>
  ...
  <td  class="tablerow"><input name="tag_config[username]" id="username" type="text" size="15" /> 可调用单个会员的促销</td>
</tr>

    <tr> 
      <td class="tablerow"><b>此标签调用的模板</b></td>
      <td  class="tablerow">
	<?=showtpl($mod,'tag_sales_thumb','tag_config[templateid]',0,'id="templateid"')?>
