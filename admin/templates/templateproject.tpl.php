...
<table cellpadding="2" cellspacing="1" border="0" align=center class="tableBorder" >
  ...
  <tr>
	...
	2、网站当前使用的模板方案为：<font color="red"><?=$templateprojectnames[$CONFIG['defaulttemplate']]?></font> ，保存路径为： <font color="red">./templates/<?=$CONFIG['defaulttemplate']?>/</font> ，其他模板方案的变化不会影响网站前台的显示。<br/>
