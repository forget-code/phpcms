...
<th colspan=4>编辑招聘信息</th>
 <tr> 
	  ...
	  <input type="hidden" name="job[station]" value="<?=$station?>"</td>
    </tr>
<tr> 
...
<tr> 
	...
	<input name="job[status]" type="radio" value="3" <?php if($_groupid<4){?>checked<?php }else{ ?>disabled<?php } ?>> 已通过&nbsp;
	<input name="job[status]" type="radio" value="1" <?php if($_groupid==4){?>checked<?php } ?>> 待审核&nbsp;
	<input name="job[status]" type="radio" value="0"> 草稿&nbsp;
	</td>
</tr>
</table>
